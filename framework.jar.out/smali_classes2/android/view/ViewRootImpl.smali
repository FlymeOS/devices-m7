...
.method private enableHardwareAcceleration(Landroid/view/WindowManager$LayoutParams;)V
    ...
    .line 713
    sget-boolean v7, Landroid/view/ViewRootImpl;->DEBUG_HTC:Z
    ...
    invoke-virtual {v7}, Landroid/view/HardwareRenderer;->destroy()V
    ...
    invoke-static {v7, v4}, Landroid/view/HardwareRenderer;->create(Landroid/content/Context;Z)Landroid/view/HardwareRenderer;
    ...
    .line 773
    sget-boolean v5, Landroid/view/ViewRootImpl;->DEBUG_HTC:Z

    if-eqz v5, :cond_9

    const-string v5, "ViewRootImpl"

    const-string v6, "Non-HTC App: Enlarge cache config for FHD"
    ...
    invoke-static {v5, v6, v7}, Landroid/view/HardwareRenderer;->setHWUICacheConfig(IIF)V
...
.method private performDraw()V
    ...
    invoke-static {v10}, Lcom/htc/utils/PerformanceLogUtil;->logFinishDrawing(Landroid/content/Context;)V
    :try_end_1
...
.method private performTraversals()V
    ...
    .line 1559
    .local v59, "surfaceGenerationId":I
    move-object/from16 v0, p0
    ...
    .line 1568
    .local v57, "strRelayoutReason":Ljava/lang/String;
    ...
    .line 1591
    .end local v57    # "strRelayoutReason":Ljava/lang/String;
    :cond_31
    move-object/from16 v0, p0
    ...
    .end local v59    # "surfaceGenerationId":I
    ...
    .restart local v57    # "strRelayoutReason":Ljava/lang/String;
    .restart local v59    # "surfaceGenerationId":I
    :cond_42
    :try_start_2
    const-string v4, "0"
    ...
    .line 1831
    .local v60, "surfaceInsets":Landroid/graphics/Rect;
    :goto_1c
    move-object/from16 v0, p0
    ...
    .line 1840
    .end local v60    # "surfaceInsets":Landroid/graphics/Rect;
    :cond_56
    move-object/from16 v0, p0
