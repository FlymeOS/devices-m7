...
.field public static final HTC_IME_PACKAGE_NAME:Ljava/lang/String; = "com.htc.sense.ime"

.field public static IMFdebug:Z = false

.field private static final IMFdebugTagPrefix:Ljava/lang/String; = "IMF_"

.field public static IMFinnerDebug:Z = false

.field private static IMFuseSameLogTag:Z = false
...
.field static final MSG_RESTART_UNCHECKED_PROCESSING:I = 0xb
...
.field private mRestartProcessing:Z
...
.method static constructor <clinit>()V
    ...
    .line 364
    const-string v0, "htc.imm.showlog"

    invoke-static {v0, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Landroid/view/inputmethod/InputMethodManager;->IMFinnerDebug:Z
    ...
    :goto_0
    sput-boolean v0, Landroid/view/inputmethod/InputMethodManager;->IMFdebug:Z

    .line 366
    const-string v0, "htc.imm.samelogtag"

    invoke-static {v0, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Landroid/view/inputmethod/InputMethodManager;->IMFuseSameLogTag:Z
...
.method constructor <init>(Lcom/android/internal/view/IInputMethodManager;Landroid/os/Looper;)V
    ...
    .line 384
    iput-boolean v1, p0, Landroid/view/inputmethod/InputMethodManager;->mIsFromRestart:Z

    .line 385
    iput-boolean v1, p0, Landroid/view/inputmethod/InputMethodManager;->mNeedToRenewIC:Z

    .line 386
    iput-boolean v1, p0, Landroid/view/inputmethod/InputMethodManager;->mRestartProcessing:Z
...
.method static synthetic access$002(Landroid/view/inputmethod/InputMethodManager;Z)Z
    .locals 0
    ...
    .prologue
    .line 207
    iput-boolean p1, p0, Landroid/view/inputmethod/InputMethodManager;->mRestartProcessing:Z

    return p1
.end method

.method static synthetic access$102(Landroid/view/inputmethod/InputMethodManager;I)I
    .locals 0
    .param p0, "x0"    # Landroid/view/inputmethod/InputMethodManager;
    .param p1, "x1"    # I
...
.method static synthetic access$200(Landroid/view/inputmethod/InputMethodManager;ZZ)Z
    .locals 1
    .param p0, "x0"    # Landroid/view/inputmethod/InputMethodManager;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method static synthetic access$400()Ljava/lang/String;
    ...
    .prologue
    .line 207
    sget-object v0, Landroid/view/inputmethod/InputMethodManager;->mPackageName:Ljava/lang/String;
...
.method private checkFocusNoStartInput(ZZ)Z
    ...
    .line 1504
    sget-boolean v2, Landroid/view/inputmethod/InputMethodManager;->IMFdebug:Z
    ...
    const-string v5, "checkFocusNoStartInput, mServedView="
...
.method public static getLogTag(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 380
    sget-boolean v0, Landroid/view/inputmethod/InputMethodManager;->IMFuseSameLogTag:Z
    ...
    .end local p0    # "defaultTag":Ljava/lang/String;
    :cond_0
    return-object p0
.end method

.method public static getMethodCallSource(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 11
    .param p0, "packageName"    # Ljava/lang/String;
    .param p1, "calledMethod"    # Ljava/lang/String;
    ...
    .line 1218
    .local v3, "foundCalledMethod":Z
    const-string v1, ""

    .line 1219
    .local v1, "calledMethodClass":Ljava/lang/String;
    ...
    .end local v1    # "calledMethodClass":Ljava/lang/String;
    .end local v3    # "foundCalledMethod":Z
    .end local v4    # "i$":I
    .end local v5    # "len$":I
    ...
    .restart local v1    # "calledMethodClass":Ljava/lang/String;
    .restart local v3    # "foundCalledMethod":Z
    .restart local v4    # "i$":I
    .restart local v5    # "len$":I
    .restart local v6    # "s":Ljava/lang/StackTraceElement;
    .restart local v7    # "sb":Ljava/lang/StringBuilder;
    .restart local v8    # "ste":[Ljava/lang/StackTraceElement;
    ...
    const-string v10, "In getMethodCallSource():"
    ...
    const-string v10, "Can not find source, "
...
.method public static updateFlag()V
    .locals 3
    ...
    const-string v2, "updateFlag, IMFinnerDebug="
    ...
    const-string v2, ", IMFuseSameLogTag="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-boolean v2, Landroid/view/inputmethod/InputMethodManager;->IMFuseSameLogTag:Z
...
.method public dispatchInputEvent(Landroid/view/InputEvent;Ljava/lang/Object;Landroid/view/inputmethod/InputMethodManager$FinishedInputEventCallback;Landroid/os/Handler;)I
    ...
    const-string v4, "dispatchInputEvent(), event="
...
.method public hideSoftInputFromWindow(Landroid/os/IBinder;ILandroid/os/ResultReceiver;)Z
    ...
    const-string v4, "hideSoftInputFromWindow"
...
.method invokeFinishedInputEventCallback(Landroid/view/inputmethod/InputMethodManager$PendingEvent;Z)V
    ...
    const-string v3, "invokeFinishedInputEventCallback() p="
...
.method public restartInput(Landroid/view/View;)V
    ...
    sget-object v1, Landroid/view/inputmethod/InputMethodManager;->mPackageName:Ljava/lang/String;
    ...
    .line 1186
    :cond_2
    iput-boolean v6, p0, Landroid/view/inputmethod/InputMethodManager;->mIsFromRestart:Z

    .line 1188
    const/4 v0, 0x0

    invoke-virtual {p0, v0, v5, v5, v5}, Landroid/view/inputmethod/InputMethodManager;->startInputInner(Landroid/os/IBinder;III)Z
...
.method public restartInputUnchecked(I)V
    .locals 6
    .param p1, "msg"    # I
    ...
    .line 1197
    iget-boolean v0, p0, Landroid/view/inputmethod/InputMethodManager;->mRestartProcessing:Z
    ...
    const-string v2, "restartInputUnchecked"
    ...
    iput-boolean v0, p0, Landroid/view/inputmethod/InputMethodManager;->mRestartProcessing:Z

    .line 1203
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/view/inputmethod/InputMethodManager;->mNeedToRenewIC:Z
    ...
    invoke-virtual {v1, v2, p1, v5}, Landroid/view/inputmethod/InputMethodManager$H;->obtainMessage(III)Landroid/os/Message;

    move-result-object v1

    const-wide/16 v2, 0x1f4

    invoke-virtual {v0, v1, v2, v3}, Landroid/view/inputmethod/InputMethodManager$H;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method sendInputEventOnMainLooperLocked(Landroid/view/inputmethod/InputMethodManager$PendingEvent;)I
    ...
    .line 1952
    .local v2, "seq":I
    sget-boolean v3, Landroid/view/inputmethod/InputMethodManager;->IMFdebug:Z
    ...
    const-string v5, "Call InputEventSender.sendInputEvent(), event="
    ...
    const-string v5, "DISPATCH_NOT_HANDLED pendingEvent="
...
.method startInputInner(Landroid/os/IBinder;III)Z
    ...
    .line 1290
    iget-boolean v1, p0, Landroid/view/inputmethod/InputMethodManager;->mNeedToRenewIC:Z

    if-eqz v1, :cond_3

    .line 1291
    invoke-virtual {v7}, Landroid/view/inputmethod/EditorInfo;->needToRenewIC()V
    ...
    iget v1, v7, Landroid/view/inputmethod/EditorInfo;->inputType:I
    ...
    sget-object v2, Landroid/view/inputmethod/InputMethodManager;->mPackageName:Ljava/lang/String;

    const-string v3, "startInputInner"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "Non input field, ic="
    ...
    .line 1306
    :cond_5
    iget-boolean v1, p0, Landroid/view/inputmethod/InputMethodManager;->mIsFromRestart:Z
    ...
    const-string v5, "Do not restart input for non input field, ic="
    ...
    const-string v3, ", windowGainingFocus="
    ...
    const-string v3, ", mServedInputConnectionWrapper="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Landroid/view/inputmethod/InputMethodManager;->mServedInputConnectionWrapper:Landroid/view/inputmethod/InputMethodManager$ControlledInputConnectionWrapper;
    ...
    const-string v3, "controlFlags=0x"
    ...
    const-string v3, "Error in startInputInner() mServedView="
...
.method public toggleSoftInputFromWindow(Landroid/os/IBinder;II)V
    ...
    const-string v3, "toggleSoftInputFromWindow"
