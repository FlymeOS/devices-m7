...
.field public static final EFFECT_MANAGER_DISABLE:I = 0x0

.field public static final EFFECT_MANAGER_ENABLE:I = 0x1
...
.field public static final HARMAN_DISABLE:I = 0x0

.field public static final HARMAN_ENABLE:I = 0x1
...
.method private isDongleConnected()Z
    ...
    const-string v5, "Dead object in isDongleConnected"
...
.method public abandonFixedDLNAVolume()V
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1}, Landroid/media/IAudioService;->abandonFixedDLNAVolume()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in abandonFixedDLNAVolume"
...
.method public getDeviceForStream(I)I
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->getDeviceForStreamUnsupported(I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in getDeviceForStream"
...
.method public getDeviceVolume(II)I
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1, p2}, Landroid/media/IAudioService;->getDeviceVolume(II)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in getDeviceVolume"
...
.method public getEffectManagerProperty(I)I
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->getEffectManagerProperty(I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "Dead object in getEffectManagerProperty"
...
.method public getFullVolumeSetting()[Ljava/lang/String;
    .locals 4
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1}, Landroid/media/IAudioService;->getFullVolumeSetting()[Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in getFullVolumeSetting"
...
.method public getHarmanProperty(I)I
    .locals 5
    .param p1, "name"    # I
    ...
    const-string v4, "Dead object in getHarmanProperty"
...
.method public getNotificationUseRingVolume()I
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1}, Landroid/media/IAudioService;->getNotificationUseRingVolume()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in getNotificationUseRingVolume"
...
.method public isFMActive()Z
    ...
    const-string v5, "Dead object in isFMActive"
...
.method public lockMusicVolumeToMax(Z)V
    ...
    invoke-interface {v1, v2, p1}, Landroid/media/IAudioService;->lockMusicVolumeToMax(Landroid/os/IBinder;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in lockMusicVolumeToMax"
...
.method public lockMusicVolumeUI(Z)V
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->lockMusicVolumeUI(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in lockMusicVolumeUI"
...
.method public requestFixedDLNAVolume(I)V
    .locals 4
    .param p1, "index"    # I
    ...
    invoke-interface {v1, v2, p1}, Landroid/media/IAudioService;->requestFixedDLNAVolume(Landroid/os/IBinder;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in requestFixedDLNAVolume"
...
.method public setBluetoothA2dpEnabled(Z)V
    .locals 4
    .param p1, "on"    # Z
    ...
    const-string v3, "Dead object in setBluetoothA2dpOn"
...
.method public setCSCallVolumeOn(Z)V
    ...
    const-string v4, "setCSCallVolumeOn("
...
.method public setDLNAPlayingOn(Z)V
    .locals 4
    .param p1, "on"    # Z
    ...
    invoke-interface {v1, v2, p1}, Landroid/media/IAudioService;->setDLNAPlayingOn(Landroid/os/IBinder;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setDLNAPlayingOn"
...
.method public setDeviceVolume(III)V
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1, p2, p3}, Landroid/media/IAudioService;->setDeviceVolume(III)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setDeviceVolume"
...
.method public setEffectManagerProperty(II)V
    ...
    const-string v4, "setEffectManagerProperty name="
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1, p2}, Landroid/media/IAudioService;->setEffectManagerProperty(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setEffectManagerProperty"
...
.method public setGlobalEffect(I)V
    .locals 4
    .param p1, "id"    # I
    ...
    invoke-interface {v1, p1, v2}, Landroid/media/IAudioService;->setGlobalEffect(ILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setHarmanProperty(II)V
    .locals 5
    .param p1, "name"    # I
    .param p2, "value"    # I
    ...
    const-string v4, "setHarmanProperty name="
    ...
    const-string v3, "Dead object in setHarmanProperty"
...
.method public setIgnoreNotificationMuteSetting(Z)I
    ...
    const-string v4, "setIgnoreNotificationMuteSetting("
...
.method public setNotificationUseRingVolume(I)V
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->setNotificationUseRingVolume(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setNotificationUseRingVolume"
...
.method public setStreamAllVolume(II)V
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1, p2}, Landroid/media/IAudioService;->setStreamAllVolume(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setStreamAllVolume"
...
.method public setVolumePanelParameters(Ljava/util/Map;)V
    ...
    const-string v3, "setVolumePanelParameters"
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->setVolumePanelParameters(Ljava/util/Map;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setVolumePanelParameters"
...
.method public triggerBecomingNoisyIntent()V
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1}, Landroid/media/IAudioService;->triggerBecomingNoisyIntent()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in triggerBecomingNoisyIntent"
