...
.field public static final PARSE_DEFAULT_CONFIG_BUTTON:I = -0x1
...
.field public static final PARSE_IS_DATA_PRELOAD:I = 0x100000

.field public static final PARSE_IS_DATA_PRELOAD_DIR:I = 0x200000
...
.method private parseBaseApk(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    .line 1386
    const-string v51, "android.uid.felicalock"

    .line 1388
    :cond_4
    const-string v3, "com.felicanetworks.test.android.device"
    ...
    .line 1389
    const-string v51, "android.uid.felica.testtool"
    ...
    .line 1554
    .local v33, "innerTagName":Ljava/lang/String;
    const-string/jumbo v3, "uses-feature"
    ...
    .line 1568
    .end local v33    # "innerTagName":Ljava/lang/String;
    :cond_1f
    if-eqz v24, :cond_20
    ...
    .line 1786
    :cond_40
    const-string/jumbo v3, "skip-erased"
    ...
    iput-boolean v3, v4, Landroid/content/pm/PackageParser$Package;->mSkipErased:Z
    ...
    .line 1791
    :cond_41
    const-string/jumbo v3, "restore-components"
    ...
    invoke-direct {v0, v4, v1, v2}, Landroid/content/pm/PackageParser;->parseRestoreComponents(Landroid/content/pm/PackageParser$Package;Lorg/xmlpull/v1/XmlPullParser;[Ljava/lang/String;)Z
    ...
    .line 1818
    .local v30, "implicitPerms":Ljava/lang/StringBuilder;
    const/16 v34, 0x0
    ...
    .end local v30    # "implicitPerms":Ljava/lang/StringBuilder;
    const/16 v3, 0x80
    ...
    .line 1827
    .restart local v30    # "implicitPerms":Ljava/lang/StringBuilder;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;
...
.method private parseBaseApplication(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;)Z
    ...
    invoke-direct/range {p0 .. p4}, Landroid/content/pm/PackageParser;->parseConfigureFlags(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)V
...
.method private parseConfigureFlags(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)V
    .locals 5
    ...
    const-string v2, "configuredExt1"
    ...
    invoke-interface {p4, v1, v4}, Landroid/util/AttributeSet;->getAttributeIntValue(II)I

    move-result v3

    iput v3, v2, Landroid/content/pm/ApplicationInfo;->configuredExtFlag:I
    ...
    invoke-interface {p4, v1, v3}, Landroid/util/AttributeSet;->getAttributeBooleanValue(IZ)Z

    move-result v3

    iput-boolean v3, v2, Landroid/content/pm/ApplicationInfo;->displayed:Z
    ...
    invoke-interface {p4, v1, v3}, Landroid/util/AttributeSet;->getAttributeIntValue(II)I

    move-result v3

    iput v3, v2, Landroid/content/pm/ApplicationInfo;->configuredButton:I

    goto :goto_1

    .line 5149
    :cond_3
    const-string v2, "htcPersistent"
    ...
    .line 5154
    :cond_4
    const-string v2, "allowSkinChange"
    ...
    invoke-interface {p4, v1, v4}, Landroid/util/AttributeSet;->getAttributeBooleanValue(IZ)Z

    move-result v3

    iput-boolean v3, v2, Landroid/content/pm/ApplicationInfo;->allowSkinChange:Z
...
.method private parseRestoreComponents(Landroid/content/pm/PackageParser$Package;Lorg/xmlpull/v1/XmlPullParser;[Ljava/lang/String;)Z
    .locals 11
    .param p1, "owner"    # Landroid/content/pm/PackageParser$Package;
    .param p2, "parser"    # Lorg/xmlpull/v1/XmlPullParser;
    .param p3, "outError"    # [Ljava/lang/String;
    ...
    invoke-interface {p2, v10, v8}, Lorg/xmlpull/v1/XmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v2, p3}, Landroid/content/pm/PackageParser;->buildClassName(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local v0    # "enabled":Ljava/lang/Integer;
    invoke-direct {v0, v7}, Ljava/lang/Integer;-><init>(I)V

    .line 4251
    .restart local v0    # "enabled":Ljava/lang/Integer;
    :cond_2
    :goto_1
    iget-object v8, p1, Landroid/content/pm/PackageParser$Package;->mRestoreComponents:Ljava/util/HashMap;
    ...
    .line 4253
    .end local v0    # "enabled":Ljava/lang/Integer;
    .end local v1    # "enabledStr":Ljava/lang/String;
    :cond_4
    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "Error in <restore-components> has not name at "
    ...
    const-string v8, "Unknown element under <restore-components>: "
