...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/content/res/Resources$ArrayMap;,
...
.field private final mColorDrawableCache:Landroid/content/res/Resources$ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/content/res/Resources$ArrayMap",
            "<",
...
.field private final mDrawableCache:Landroid/content/res/Resources$ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/content/res/Resources$ArrayMap",
            "<",
...
.method private constructor <init>()V
    ...
    new-instance v0, Landroid/content/res/Resources$ArrayMap;

    invoke-direct {v0, v2}, Landroid/content/res/Resources$ArrayMap;-><init>(Landroid/content/res/Resources$1;)V

    iput-object v0, p0, Landroid/content/res/Resources;->mDrawableCache:Landroid/content/res/Resources$ArrayMap;

    new-instance v0, Landroid/content/res/Resources$ArrayMap;

    invoke-direct {v0, v2}, Landroid/content/res/Resources$ArrayMap;-><init>(Landroid/content/res/Resources$1;)V

    iput-object v0, p0, Landroid/content/res/Resources;->mColorDrawableCache:Landroid/content/res/Resources$ArrayMap;
...
.method private cacheDrawable(Landroid/util/TypedValue;Landroid/content/res/Resources$Theme;ZLandroid/content/res/Resources$ArrayMap;JLandroid/graphics/drawable/Drawable;)V
    .locals 7
    ...
    .prologue
    .line 2400
    .local p4, "caches":Landroid/content/res/Resources$ArrayMap;, "Landroid/content/res/Resources$ArrayMap<Ljava/lang/String;Landroid/util/LongSparseArray<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;>;"
    ...
    :goto_1
    invoke-virtual {p4, v2}, Landroid/content/res/Resources$ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p4, v2, v3}, Landroid/content/res/Resources$ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private clearDrawableCachesLocked(Landroid/content/res/Resources$ArrayMap;I)V
    .locals 7
    .param p2, "configChanges"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .line 1874
    .local p1, "caches":Landroid/content/res/Resources$ArrayMap;, "Landroid/content/res/Resources$ArrayMap<Ljava/lang/String;Landroid/util/LongSparseArray<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;>;"
    invoke-virtual {p1}, Landroid/content/res/Resources$ArrayMap;->keySet()Ljava/util/Set;
    ...
    invoke-virtual {p1, v2}, Landroid/content/res/Resources$ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Landroid/util/LongSparseArray;

    invoke-direct {p0, v6, p2}, Landroid/content/res/Resources;->clearDrawableCacheLocked(Landroid/util/LongSparseArray;I)V
...
.method private getCachedDrawable(Landroid/content/res/Resources$ArrayMap;JLandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    .locals 6
    .param p2, "key"    # J
    ...
    :goto_0
    invoke-virtual {p1, v0}, Landroid/content/res/Resources$ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final finishPreloading()V
    ...
    .line 2267
    iput-boolean v3, p0, Landroid/content/res/Resources;->mPreloading:Z
    ...
    const-string v2, "[Common control][AssetManager Preload Drawable]["
    ...
    const-string v2, "][More is better]"
...
.method loadDrawable(Landroid/util/TypedValue;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, p0, Landroid/content/res/Resources;->mColorDrawableCache:Landroid/content/res/Resources$ArrayMap;

    .line 2353
    .local v5, "caches":Landroid/content/res/Resources$ArrayMap;, "Landroid/content/res/Resources$ArrayMap<Ljava/lang/String;Landroid/util/LongSparseArray<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;>;"
    ...
    .line 2363
    invoke-direct {p0, v5, v6, v7, p3}, Landroid/content/res/Resources;->getCachedDrawable(Landroid/content/res/Resources$ArrayMap;JLandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .end local v5    # "caches":Landroid/content/res/Resources$ArrayMap;, "Landroid/content/res/Resources$ArrayMap<Ljava/lang/String;Landroid/util/LongSparseArray<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;>;"
    .end local v6    # "key":J
    :cond_0
    const/4 v4, 0x0
    ...
    iget-object v5, p0, Landroid/content/res/Resources;->mDrawableCache:Landroid/content/res/Resources$ArrayMap;

    .line 2357
    .restart local v5    # "caches":Landroid/content/res/Resources$ArrayMap;, "Landroid/content/res/Resources$ArrayMap<Ljava/lang/String;Landroid/util/LongSparseArray<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;>;"
    ...
    .line 2391
    invoke-direct/range {v1 .. v8}, Landroid/content/res/Resources;->cacheDrawable(Landroid/util/TypedValue;Landroid/content/res/Resources$Theme;ZLandroid/content/res/Resources$ArrayMap;JLandroid/graphics/drawable/Drawable;)V
...
.method public updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    iget-object v2, v0, Landroid/content/res/Resources;->mDrawableCache:Landroid/content/res/Resources$ArrayMap;

    move-object/from16 v0, p0

    move/from16 v1, v20

    invoke-direct {v0, v2, v1}, Landroid/content/res/Resources;->clearDrawableCachesLocked(Landroid/content/res/Resources$ArrayMap;I)V

    .line 1851
    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/content/res/Resources;->mColorDrawableCache:Landroid/content/res/Resources$ArrayMap;
