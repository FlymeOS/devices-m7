...
.field protected static final EVENT_DELAY_CALL_STATE_CHANGE:I = 0x3b

.field protected static final EVENT_DELAY_PHONE_STATE_CHANGE:I = 0x43
...
.field protected static final EVENT_UNSOL_VOICE_SPEECH_CODEC_INFO:I = 0x42
...
.field protected mVoiceSpeechCodecInfo:[Ljava/lang/String;
...
.method protected resetVoiceSpeechCodecInfo()V
    .locals 3

    .prologue
    .line 395
    const-string v1, "resetVoiceSpeechCodecInfo"

    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/CallTracker;->log(Ljava/lang/String;)V

    .line 396
    iget-object v1, p0, Lcom/android/internal/telephony/CallTracker;->mVoiceSpeechCodecInfo:[Ljava/lang/String;
...
.method protected updateAccessoryFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .param p2, "toState"    # Ljava/lang/String;
...
.method protected updateConnVoiceSpeechCodecInfo(ILcom/android/internal/telephony/Connection;)Z
    .locals 4
    .param p1, "index"    # I
    ...
    .line 405
    .local v0, "changed":Z
    iget-object v2, p0, Lcom/android/internal/telephony/CallTracker;->mVoiceSpeechCodecInfo:[Ljava/lang/String;
    ...
    invoke-virtual {p2, v2}, Lcom/android/internal/telephony/Connection;->updateCodecInfo(Ljava/lang/String;)Z
    ...
    const-string v3, "[codec] updateConnVoiceSpeechCodecInfo, index: "
