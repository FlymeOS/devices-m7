...
.method public static resolveInstallLocation(Landroid/content/Context;Ljava/lang/String;IJI)I
    ...
    .line 344
    .local v7, "existingInfo":Landroid/content/pm/ApplicationInfo;
    :try_start_0
    ...
    invoke-virtual {v11, v12}, Landroid/os/storage/StorageManager;->getStorageBytesUntilLow(Ljava/io/File;)J
    ...
    invoke-direct {v13, v14}, Landroid/os/Environment$UserEnvironment;-><init>(I)V
    ...
    .line 354
    .end local v2    # "bSdAsExteranl":Z
    .end local v3    # "bSdMounted":Z
    .end local v4    # "bSdSlot":Z
    .end local v5    # "checkBoth":Z
    .end local v6    # "emulated":Z
    .end local v8    # "fitsOnExternal":Z
    ...
    .line 366
    iget v13, v7, Landroid/content/pm/ApplicationInfo;->flags:I
    ...
    .line 391
    .restart local v2    # "bSdAsExteranl":Z
    .restart local v9    # "fitsOnInternal":Z
    .restart local v12    # "target":Ljava/io/File;
    :cond_d
    const/4 v9, 0x0
    ...
    .line 400
    .restart local v8    # "fitsOnExternal":Z
    :cond_e
    const/4 v8, 0x0
