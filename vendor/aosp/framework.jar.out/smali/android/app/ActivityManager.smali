...
.field public static final REMOVE_TASK_WITHOUT_PERSISTER:I = 0x1000
...
.method public clearRecentTasks([II)V
    .locals 1
    .param p1, "taskIds"    # [I
    .param p2, "flags"    # I
    ...
    invoke-interface {v0, p1, p2}, Landroid/app/IActivityManager;->clearRecentTasks([II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public skipStartingWindowOnNextActivity()V
    ...
    invoke-interface {v0}, Landroid/app/IActivityManager;->skipStartingWindowOnNextActivity()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
