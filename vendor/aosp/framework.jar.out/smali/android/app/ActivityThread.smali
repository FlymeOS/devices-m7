...
.field private static final DISABLE_GC_TOLERANCE_RANGE:J = 0x2L
...
.field public static KEY_KEEP_RESUMED:Ljava/lang/String; = null
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/app/ActivityThread;->DEBUG_SCRSHARE:Z

    .line 5703
    const-string v0, "_KR_"

    sput-object v0, Landroid/app/ActivityThread;->KEY_KEEP_RESUMED:Ljava/lang/String;
...
.method constructor <init>()V
    ...
    new-instance v1, Landroid/app/HtcDeviceInfoATListener;

    invoke-direct {v1}, Landroid/app/HtcDeviceInfoATListener;-><init>()V
...
.method private attach(Z)V
    ...
    const-string v6, "attach ApplicationThread="
    ...
    iput-boolean v4, v2, Landroid/content/pm/ApplicationInfo;->htcApp:Z

    .line 5556
    const/4 v4, 0x1

    iput-boolean v4, v2, Landroid/content/pm/ApplicationInfo;->hasHtcSignature:Z
...
.method private deliverNewIntents(Landroid/app/ActivityThread$ActivityClientRecord;Ljava/util/List;)V
    ...
    invoke-static {v3}, Landroid/app/ActivityThread;->setEnableGC(Z)V
    ...
    :cond_0
    invoke-static {v5}, Landroid/app/ActivityThread;->setEnableGC(Z)V
...
.method private handleCreateBackupAgent(Landroid/app/ActivityThread$CreateBackupAgentData;)V
    ...
    .line 2753
    .local v14, "requestedPackage":Landroid/content/pm/PackageInfo;
    ...
    .line 2840
    .end local v14    # "requestedPackage":Landroid/content/pm/PackageInfo;
    :goto_0
    return-void
    ...
    .restart local v14    # "requestedPackage":Landroid/content/pm/PackageInfo;
    :cond_0
    ...
    .line 2836
    .end local v4    # "agent":Landroid/app/backup/BackupAgent;
...
.method private handleLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)V
    ...
    :goto_0
    invoke-virtual {p0, v8, v7, v9, v5}, Landroid/app/ActivityThread;->handleResumeActivity(Landroid/os/IBinder;ZZZ)V
    ...
    invoke-direct {v5, v7}, Landroid/util/SuperNotCalledException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v7, v2}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    :cond_4
    iput-boolean v6, p1, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z
...
.method private handlePauseActivity(Landroid/os/IBinder;ZZIZ)V
    ...
    .line 3427
    invoke-static {v1}, Landroid/app/ActivityThread;->setEnableGC(Z)V
    ...
    iget-boolean v1, v0, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z

    if-eqz v1, :cond_1

    .line 3432
    sget-boolean v1, Landroid/app/ActivityThread;->DEBUG_SCRSHARE:Z
    ...
    const-string v3, "Finish, cancel KeepResume, "
    ...
    iput-boolean v1, v0, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z
    ...
    .line 3459
    :cond_5
    invoke-static {v4}, Landroid/app/ActivityThread;->setEnableGC(Z)V
...
.method private handleReceiver(Landroid/app/ActivityThread$ReceiverData;)V
    ...
    .end local v11    # "receiver":Landroid/content/BroadcastReceiver;
    :catch_0
    move-exception v8
    ...
    .restart local v11    # "receiver":Landroid/content/BroadcastReceiver;
    :catch_1
    move-exception v8
...
.method private handleServiceArgs(Landroid/app/ActivityThread$ServiceArgsData;)V
    ...
    .line 3060
    .local v7, "s":Landroid/app/Service;
    if-eqz v7, :cond_4
    ...
    .restart local v5    # "logQueuedWork":Z
    .restart local v6    # "res":I
    .restart local v8    # "startTime":J
    :catch_1
    move-exception v10
...
.method private handleSetCoreSettings(Landroid/os/Bundle;)V
    ...
    sget-object v0, Landroid/app/ActivityThread;->KEY_KEEP_RESUMED:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Landroid/app/ActivityThread;->setKeepResumed(Ljava/lang/String;)V
...
.method private handleStopService(Landroid/os/IBinder;)V
    ...
    .line 3156
    .end local v1    # "e":Ljava/lang/Exception;
    .restart local v4    # "logQueuedWork":Z
    .restart local v6    # "startTime":J
    :catch_1
    move-exception v9
...
.method public static isTopApp()Z
    ...
    # getter for: Landroid/app/ActivityThread$ApplicationThread;->mLastProcessState:I
    invoke-static {v2}, Landroid/app/ActivityThread$ApplicationThread;->access$3400(Landroid/app/ActivityThread$ApplicationThread;)I
...
.method private static performConfigurationChanged(Landroid/content/ComponentCallbacks2;Landroid/content/res/Configuration;)V
    ...
    .line 4392
    invoke-static {p0, v4, v5}, Lcom/htc/utils/PerformanceLogUtil;->logPerformConfigurationChange(Landroid/content/ComponentCallbacks;J)V
    ...
    invoke-direct {v3, v6}, Landroid/util/SuperNotCalledException;-><init>(Ljava/lang/String;)V
...
.method private performDestroyActivity(Landroid/os/IBinder;ZIZ)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    .line 3950
    iget-boolean v7, v6, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z
    ...
    iput-boolean v7, v6, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z

    .line 3952
    sget-boolean v7, Landroid/app/ActivityThread;->DEBUG_SCRSHARE:Z
    ...
    const-string v11, "Cancel KeepResumed for destroy, "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, v6, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;
    ...
    iget v10, v7, Landroid/app/Activity;->mConfigChangeFlags:I

    or-int v10, v10, p3

    iput v10, v7, Landroid/app/Activity;->mConfigChangeFlags:I
    ...
    iput-boolean v10, v7, Landroid/app/Activity;->mFinished:Z

    .line 3961
    :cond_1
    iget-boolean v7, v6, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z
    ...
    iput-boolean v10, v7, Landroid/app/Activity;->mCalled:Z

    .line 3964
    iget-object v7, p0, Landroid/app/ActivityThread;->mInstrumentation:Landroid/app/Instrumentation;

    iget-object v10, v6, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;

    invoke-virtual {v7, v10}, Landroid/app/Instrumentation;->callActivityOnPause(Landroid/app/Activity;)V

    .line 3967
    iget-object v7, p0, Landroid/app/ActivityThread;->mCallbacks:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v7}, Lcom/htc/callbacks/ActivityThreadCallbacks;->afterCallActivityOnPause(Landroid/app/Activity;)V
    :try_end_0
    .catch Landroid/util/SuperNotCalledException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
    ...
    .line 3980
    .local v4, "e":Landroid/util/SuperNotCalledException;
    throw v4

    .line 3972
    .end local v4    # "e":Landroid/util/SuperNotCalledException;
    ...
    iget-object v12, v6, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;
    ...
    iget-object v11, v6, Landroid/app/ActivityThread$ActivityClientRecord;->intent:Landroid/content/Intent;

    invoke-static {v11}, Landroid/app/ActivityThread;->safeToComponentShortString(Landroid/content/Intent;)Ljava/lang/String;
    ...
    const-string v11, " did not call through to super.onPause()"
    ...
    invoke-direct {v7, v10}, Landroid/util/SuperNotCalledException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v10, v4}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v11, "Unable to pause activity "
    ...
    invoke-direct {v7, v10, v4}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iput-boolean v7, v6, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z

    .line 3991
    :cond_4
    iget-boolean v7, v6, Landroid/app/ActivityThread$ActivityClientRecord;->stopped:Z
    ...
    :try_end_2
    .catch Landroid/util/SuperNotCalledException; {:try_start_2 .. :try_end_2} :catch_3
    ...
    iput-boolean v7, v6, Landroid/app/ActivityThread$ActivityClientRecord;->stopped:Z
    ...
    iput-object v7, v6, Landroid/app/ActivityThread$ActivityClientRecord;->lastNonConfigurationInstances:Landroid/app/Activity$NonConfigurationInstances;
    :try_end_3
    ...
    invoke-virtual {v7, v10}, Landroid/app/Instrumentation;->callActivityOnDestroy(Landroid/app/Activity;)V

    .line 4028
    sget-boolean v7, Landroid/app/ActivityThread;->PERF_LOG:Z
    ...
    .line 3995
    .restart local v4    # "e":Landroid/util/SuperNotCalledException;
    throw v4
    ...
    const-string v11, "Unable to stop activity "
    ...
    const-string v11, "Unable to retain activity "
    ...
    :cond_9
    :try_start_5
    iget-object v7, v6, Landroid/app/ActivityThread$ActivityClientRecord;->window:Landroid/view/Window;
    ...
    const-string v11, "Unable to destroy activity "
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    :try_end_7
    .catch Landroid/util/SuperNotCalledException; {:try_start_7 .. :try_end_7} :catch_0
...
.method private performStopActivityInner(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/ActivityThread$StopInfo;ZZ)V
    ...
    iput-boolean v1, p1, Landroid/app/ActivityThread$ActivityClientRecord;->resumePerformed:Z

    .line 3611
    iget-boolean v1, p1, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z
    ...
    const-string v3, "KeepResumed, skip performStopActivityInner, "
...
.method static setEnableGC(Z)V
    ...
    invoke-virtual {v0, v2, v3}, Ldalvik/system/VMRuntime;->disableGcInRange(J)V
...
.method private setupGraphicsSupport(Landroid/app/LoadedApk;Ljava/io/File;)V
    ...
    .line 4635
    .local v1, "uid":I
    const-string/jumbo v2, "ro.boot.ftm"
...
.method private updateVisibility(Landroid/app/ActivityThread$ActivityClientRecord;Z)V
    ...
    const-string v3, "KeepResumed, skip updateVisibility to hide "
...
.method public final acquireProvider(Landroid/content/Context;Ljava/lang/String;IZ)Landroid/content/IContentProvider;
    ...
    .line 5055
    :goto_2
    iget-object v9, v2, Landroid/app/IActivityManager$ContentProviderHolder;->provider:Landroid/content/IContentProvider;
    ...
    const-string v3, ") may suddenly died, retry once"
    ...
    const-string v3, ") is still unusable, return null to prevent query crash"
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    # getter for: Landroid/app/ActivityThread$ApplicationThread;->mLastProcessState:I
    invoke-static {v6}, Landroid/app/ActivityThread$ApplicationThread;->access$3400(Landroid/app/ActivityThread$ApplicationThread;)I
    ...
    .line 4482
    invoke-static {v2, v3}, Lcom/htc/utils/PerformanceLogUtil;->logHandleConfigurationChangedEnd(J)V
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZZ)V
    ...
    invoke-static {v7}, Landroid/app/ActivityThread;->setEnableGC(Z)V
    ...
    invoke-static {v8}, Landroid/app/ActivityThread;->setEnableGC(Z)V
...
.method final performPauseActivity(Landroid/app/ActivityThread$ActivityClientRecord;ZZ)Landroid/os/Bundle;
    ...
    .line 3482
    iput-boolean v5, p1, Landroid/app/ActivityThread$ActivityClientRecord;->resumePerformed:Z

    .line 3483
    iget-boolean v6, p1, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z

    if-eqz v6, :cond_1

    .line 3484
    sget-boolean v6, Landroid/app/ActivityThread;->DEBUG_SCRSHARE:Z
    ...
    const-string v9, "KeepResumed, skip performPauseActivity, "
    ...
    iput-boolean v11, v6, Landroid/app/Activity;->mFinished:Z
    ...
    .line 3514
    iget-object v6, p0, Landroid/app/ActivityThread;->mCallbacks:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v6}, Lcom/htc/callbacks/ActivityThreadCallbacks;->afterCallActivityOnPause(Landroid/app/Activity;)V
    :try_end_0
    .catch Landroid/util/SuperNotCalledException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
...
.method public final performResumeActivity(Landroid/os/IBinder;Z)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    .line 3175
    iput-boolean v6, v3, Landroid/app/ActivityThread$ActivityClientRecord;->resumePerformed:Z

    .line 3176
    iget-boolean v4, v3, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z

    if-eqz v4, :cond_1

    .line 3177
    sget-boolean v4, Landroid/app/ActivityThread;->DEBUG_SCRSHARE:Z
    ...
    const-string v6, "KeepResumed, skip performResumeActivity, "
    ...
    iput-object v4, v3, Landroid/app/ActivityThread$ActivityClientRecord;->persistentState:Landroid/os/PersistableBundle;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
...
.method final performUserLeavingActivity(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    .prologue
    .line 3464
    iget-boolean v0, p1, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z

    if-eqz v0, :cond_1

    .line 3465
    sget-boolean v0, Landroid/app/ActivityThread;->DEBUG_SCRSHARE:Z
    ...
    const-string v2, "KeepResumed, skip performUserLeavingActivity, "
...
.method setKeepResumed(Ljava/lang/String;)V
    .locals 9
    ...
    .line 5709
    iput-boolean v5, v3, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z
    ...
    const-string v7, "KeepResumed to "
    ...
    .end local v4    # "sname":Ljava/lang/String;
    :cond_5
    iget-boolean v7, v3, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z

    if-eqz v7, :cond_0

    .line 5718
    iput-boolean v6, v3, Landroid/app/ActivityThread$ActivityClientRecord;->keepResumed:Z

    .line 5719
    iget-boolean v7, v3, Landroid/app/ActivityThread$ActivityClientRecord;->resumePerformed:Z

    if-eqz v7, :cond_6

    iget-boolean v7, v3, Landroid/app/ActivityThread$ActivityClientRecord;->stopped:Z

    if-eqz v7, :cond_7

    .line 5720
    :cond_6
    invoke-virtual {p0, v3}, Landroid/app/ActivityThread;->performUserLeavingActivity(Landroid/app/ActivityThread$ActivityClientRecord;)V

    .line 5721
    invoke-virtual {p0, v3, v6, v6}, Landroid/app/ActivityThread;->performPauseActivity(Landroid/app/ActivityThread$ActivityClientRecord;ZZ)Landroid/os/Bundle;

    .line 5722
    const/4 v7, 0x0

    invoke-direct {p0, v3, v7, v6, v5}, Landroid/app/ActivityThread;->performStopActivityInner(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/ActivityThread$StopInfo;ZZ)V
    ...
    .line 5725
    :cond_7
    sget-boolean v5, Landroid/app/ActivityThread;->DEBUG_SCRSHARE:Z
    ...
    const-string v7, "Stop KeepResumed to "
