...
.field private static HTC_CUSTOMIZATION_KEY_LOWER_FP_QUALITY:Ljava/lang/String; = null
...
.field public static final INTENT_ALLOW_CAMERA_CHANGE:Ljava/lang/String; = "com.htc.admin.ALLOW_CAMERA_CHANGE"
...
.field public static final INTENT_DISK_ENCRYPTION_SETTING_CHANGE:Ljava/lang/String; = "com.htc.admin.DISK_ENCRYPTION_SETTING_CHANGE"
...
.field public static final PASSWORD_QUALITY_FINGERPRINT:I = 0x55000

.field public static final PASSWORD_QUALITY_LOWER_FINGERPRINT:I = 0x9000
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/app/admin/DevicePolicyManager;->HTC_CUSTOMIZATION_NAME_CORE_FRAMEWORK:Ljava/lang/String;

    .line 98
    const-string v0, "devicepolicy_has_mdm_api_phase_2"

    sput-object v0, Landroid/app/admin/DevicePolicyManager;->HTC_CUSTOMIZATION_KEY_MDM_API_PHASE_2:Ljava/lang/String;
    ...
    .line 104
    const-string v0, "devicepolicy_lower_fp_quality"

    sput-object v0, Landroid/app/admin/DevicePolicyManager;->HTC_CUSTOMIZATION_KEY_LOWER_FP_QUALITY:Ljava/lang/String;
...
.method public static getPasswordQualityFingerprint()I
    .locals 5
    ...
    sget-object v2, Landroid/app/admin/DevicePolicyManager;->HTC_CUSTOMIZATION_NAME_CORE_FRAMEWORK:Ljava/lang/String;

    invoke-static {v2}, Landroid/app/admin/DevicePolicyManager;->getCustomizationReader(Ljava/lang/String;)Lcom/htc/customization/HtcCustomizationReader;

    move-result-object v2

    sput-object v2, Landroid/app/admin/DevicePolicyManager;->mCustReader:Lcom/htc/customization/HtcCustomizationReader;

    .line 278
    sget-object v2, Landroid/app/admin/DevicePolicyManager;->mCustReader:Lcom/htc/customization/HtcCustomizationReader;
    ...
    sget-object v3, Landroid/app/admin/DevicePolicyManager;->HTC_CUSTOMIZATION_KEY_LOWER_FP_QUALITY:Ljava/lang/String;
...
.method public static isFactoryRestrictionSupported()Z
    ...
    .line 291
    sget-object v1, Landroid/app/admin/DevicePolicyManager;->HTC_CUSTOMIZATION_NAME_CORE_FRAMEWORK:Ljava/lang/String;
...
.method public static isMDMAPIPhase2Supported()Z
    ...
    sget-object v2, Landroid/app/admin/DevicePolicyManager;->HTC_CUSTOMIZATION_KEY_MDM_API_PHASE_2:Ljava/lang/String;
...
.method public addEasAccount(Lcom/htc/app/admin/EasAccountInfo;)V
    ...
    invoke-interface {v1, p1}, Landroid/app/admin/IDevicePolicyManager;->addEasAccount(Lcom/htc/app/admin/EasAccountInfo;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public addVPN(Lcom/htc/app/admin/VpnConfigInfo;)V
    ...
    invoke-interface {v1, p1}, Landroid/app/admin/IDevicePolicyManager;->addVPN(Lcom/htc/app/admin/VpnConfigInfo;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public deleteEasAccount(Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1}, Landroid/app/admin/IDevicePolicyManager;->deleteEasAccount(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public deleteVPN(Lcom/htc/app/admin/VpnConfigInfo;)V
    ...
    invoke-interface {v1, p1}, Landroid/app/admin/IDevicePolicyManager;->deleteVPN(Lcom/htc/app/admin/VpnConfigInfo;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public encryptSDcards()I
    ...
    invoke-interface {v2}, Landroid/app/admin/IDevicePolicyManager;->encryptSDcards()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getActiveSyncDeviceId()V
    ...
    invoke-interface {v1}, Landroid/app/admin/IDevicePolicyManager;->getActiveSyncDeviceId()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getDeviceAdminRestrictedStatus(Landroid/content/ComponentName;)I
    .locals 1
    .param p1, "who"    # Landroid/content/ComponentName;
    ...
    invoke-virtual {p0, p1, v0}, Landroid/app/admin/DevicePolicyManager;->getDeviceAdminRestrictedStatus(Landroid/content/ComponentName;I)I
...
.method public getDeviceAdminRestrictedStatus(Landroid/content/ComponentName;I)I
    ...
    invoke-interface {v2, p1, p2}, Landroid/app/admin/IDevicePolicyManager;->getDeviceAdminRestrictedStatus(Landroid/content/ComponentName;I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getEdmVersion()Ljava/lang/String;
    ...
    invoke-interface {v2}, Landroid/app/admin/IDevicePolicyManager;->getEdmVersion()Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getVPNByConfigId(Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1}, Landroid/app/admin/IDevicePolicyManager;->getVPNByConfigId(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public htcSetActivePasswordState(IIIIIIIIIZI)V
    ...
    invoke-interface/range {v0 .. v11}, Landroid/app/admin/IDevicePolicyManager;->htcSetActivePasswordState(IIIIIIIIIZI)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public htcWrapSetActivePasswordState(IIIIIIII)V
    ...
    invoke-virtual/range {v0 .. v9}, Landroid/app/admin/DevicePolicyManager;->htcWrapSetActivePasswordState(IIIIIIIII)V

    .line 2622
    return-void
.end method

.method public htcWrapSetActivePasswordState(IIIIIIIII)V
    .locals 0
    .param p1, "quality"    # I
    .param p2, "length"    # I
    .param p3, "letters"    # I
    ...
    .prologue
    .line 2629
    invoke-virtual/range {p0 .. p9}, Landroid/app/admin/DevicePolicyManager;->setActivePasswordState(IIIIIIIII)V
...
.method public installCertification(Lcom/htc/app/admin/CertInfo;)V
    ...
    invoke-interface {v1, p1}, Landroid/app/admin/IDevicePolicyManager;->installCertification(Lcom/htc/app/admin/CertInfo;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isActivePasswordLengthSufficient()Z
    .locals 3
    ...
    invoke-interface {v1, v2}, Landroid/app/admin/IDevicePolicyManager;->isActivePasswordLengthSufficient(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public responseAsyncResult(IILandroid/content/Intent;)V
    ...
    invoke-interface {v1, p1, p2, p3}, Landroid/app/admin/IDevicePolicyManager;->responseAsyncResult(IILandroid/content/Intent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setActivePasswordState2(IIIIIIIIII)V
    ...
    invoke-interface/range {v0 .. v10}, Landroid/app/admin/IDevicePolicyManager;->setActivePasswordState2(IIIIIIIIII)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setDeviceAdminRestricted(Landroid/content/ComponentName;I)V
    .locals 3
    .param p1, "who"    # Landroid/content/ComponentName;
    .param p2, "allow"    # I
    ...
    invoke-interface {v1, p1, p2, v2}, Landroid/app/admin/IDevicePolicyManager;->setDeviceAdminRestricted(Landroid/content/ComponentName;II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public wipeAllSDcards()V
    ...
    invoke-interface {v1}, Landroid/app/admin/IDevicePolicyManager;->wipeAllSDcards()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
