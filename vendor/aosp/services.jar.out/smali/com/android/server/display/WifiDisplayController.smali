...
.method private updateConnection()V
    ...
    .line 654
    invoke-virtual {p0, v3}, Lcom/android/server/display/WifiDisplayController;->setMiracastStatus(Z)V
    ...
    const-string v2, "Clear mAvailableWifiDisplayPeers and update scan result immediately"
    ...
    .line 771
    invoke-virtual {p0, v14}, Lcom/android/server/display/WifiDisplayController;->setMiracastStatus(Z)V
    ...
    invoke-direct {v3, p0, v9}, Lcom/android/server/display/WifiDisplayController$15;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    invoke-direct {v0, p0, v10}, Lcom/android/server/display/WifiDisplayController$16;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)V
...
.method public getPeerExisted(Ljava/lang/String;)Z
    .locals 6
    ...
    const-string v4, "mAvailableWifiDisplayPeers.isEmpty():"
    ...
    iput-boolean v2, p0, Lcom/android/server/display/WifiDisplayController;->mPeerExisted:Z

    .line 303
    .end local v0    # "device":Landroid/net/wifi/p2p/WifiP2pDevice;
    :cond_0
    iget-boolean v2, p0, Lcom/android/server/display/WifiDisplayController;->mPeerExisted:Z

    if-eqz v2, :cond_2

    const-string v2, "WifiDisplayController"

    const-string v3, "match device is found"
    ...
    const-string v4, "mPeerExisted "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v4, p0, Lcom/android/server/display/WifiDisplayController;->mPeerExisted:Z
    ...
    :cond_1
    iput-boolean v5, p0, Lcom/android/server/display/WifiDisplayController;->mPeerExisted:Z
    ...
    const-string v3, "cannot find match device"
...
.method public requestConnect(Ljava/lang/String;)V
    ...
    const-string v4, "requestConnect: device.deviceAddress: "
    ...
    const-string v4, ", request address: "
...
.method public setMiracastStatus(Z)V
    .locals 3
    .param p1, "isMiracastOn"    # Z
    ...
    invoke-virtual {v0, v1, v2}, Landroid/net/wifi/p2p/WifiP2pManager;->setMiracastStatusOn(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/p2p/WifiP2pManager$ActionListener;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/net/wifi/p2p/WifiP2pManager;->setMiracastStatusOff(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/p2p/WifiP2pManager$ActionListener;)V
