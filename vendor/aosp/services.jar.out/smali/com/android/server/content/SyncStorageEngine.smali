...
# instance fields
.field custManager:Lcom/htc/customization/HtcCustomizationManager;
...
.method private constructor <init>(Landroid/content/Context;Ljava/io/File;)V
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mAuthorities:Landroid/util/SparseArray;
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mAccounts:Ljava/util/HashMap;
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mPendingOperations:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mCurrentSyncs:Landroid/util/SparseArray;
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mSyncStatus:Landroid/util/SparseArray;
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mSyncHistory:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mChangeListeners:Landroid/os/RemoteCallbackList;
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mServices:Landroid/util/ArrayMap;

    .line 445
    iput v5, p0, Lcom/android/server/content/SyncStorageEngine;->mNextAuthorityId:I

    .line 448
    const/16 v3, 0x1c

    new-array v3, v3, [Lcom/android/server/content/SyncStorageEngine$DayStats;

    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mDayStats:[Lcom/android/server/content/SyncStorageEngine$DayStats;

    .line 486
    iput v5, p0, Lcom/android/server/content/SyncStorageEngine;->mNumPendingFinished:I
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mMasterSyncAutomatically:Landroid/util/SparseArray;
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->custManager:Lcom/htc/customization/HtcCustomizationManager;
    ...
    .line 503
    iget-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->custManager:Lcom/htc/customization/HtcCustomizationManager;
    ...
    const-string v3, "sync_autosync_default"

    invoke-interface {v0, v3, v6}, Lcom/htc/customization/HtcCustomizationReader;->readBoolean(Ljava/lang/String;Z)Z
    ...
    const-string v5, "pending.xml"

    invoke-direct {v4, v1, v5}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-direct {v3, v4}, Landroid/util/AtomicFile;-><init>(Ljava/io/File;)V

    iput-object v3, p0, Lcom/android/server/content/SyncStorageEngine;->mPendingFile:Landroid/util/AtomicFile;
