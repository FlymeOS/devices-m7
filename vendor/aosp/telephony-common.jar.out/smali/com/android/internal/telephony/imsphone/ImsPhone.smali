...
.field protected static final EVENT_GET_CALL_BARRING_DONE:I = 0x25

.field protected static final EVENT_GET_CALL_WAITING_DONE:I = 0x27

.field protected static final EVENT_SET_CALL_BARRING_DONE:I = 0x24

.field protected static final EVENT_SET_CALL_WAITING_DONE:I = 0x26
...
.method constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/PhoneNotifier;Lcom/android/internal/telephony/Phone;)V
    ...
    .line 130
    iput v3, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mVmImsCount:I
...
.method public clearVoiceMessageWaiting()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhone;->setVoiceMessageWaiting(II)V
...
.method public getMessageWaitingIndicator()Z
    ...
    .prologue
    .line 1423
    iget v0, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mVmImsCount:I
...
.method public getMessageWaitingIndicatorEnhanced()I
    ...
    .prologue
    .line 1433
    invoke-virtual {p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getVoiceMessageCount()I
...
.method notifyDisconnect(Lcom/android/internal/telephony/Connection;)V
    ...
    .prologue
    .line 1448
    iget-object v5, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mDisconnectRegistrants:Landroid/os/RegistrantList;

    invoke-virtual {v5, p1}, Landroid/os/RegistrantList;->notifyResult(Ljava/lang/Object;)V

    .line 1451
    const/4 v4, 0x0

    .line 1452
    .local v4, "startECMtimer":Z
    if-eqz p1, :cond_0
    ...
    .line 1455
    .local v3, "numAddress":Ljava/lang/String;
    ...
    iput-boolean v5, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mIsPhoneInEcmState:Z

    .line 1460
    iget-boolean v5, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mIsPhoneInEcmState:Z
    ...
    const-string v6, "notifyDisconnect:start to ecm timer"

    invoke-static {v5, v6}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1462
    const-string v5, "ro.cdma.ecmexittimer"
    ...
    iget-object v5, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mExitEcmRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0, v5, v0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhone;->postDelayed(Ljava/lang/Runnable;J)Z

    .line 1469
    .end local v0    # "htcDelayInMillis":J
    .end local v2    # "inEcm":Ljava/lang/String;
    .end local v3    # "numAddress":Ljava/lang/String;
    :cond_0
    return-void

    .line 1455
    .restart local v3    # "numAddress":Ljava/lang/String;
    :cond_1
    const/4 v4, 0x0
...
.method public setVoiceMessageWaiting(II)V
    ...
    .prologue
    .line 1440
    iput p2, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mVmImsCount:I

    .line 1442
    invoke-virtual {p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->notifyMessageWaitingIndicator()V
...
.method public bridge synthetic updateCurrentCarrierInProvider()Z
    ...
    .prologue
    .line 97
    invoke-super {p0}, Lcom/android/internal/telephony/imsphone/ImsPhoneBase;->updateCurrentCarrierInProvider()Z
