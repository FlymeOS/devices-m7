...
.field private static final MMS_DB_PHONE_TYPE_CDMA:I = 0x1

.field private static final MMS_DB_PHONE_TYPE_GSM:I = 0x2

.field private static final MMS_DB_PHONE_TYPE_NONE:I = 0x0

.field private static final MMS_DB_PHONE_TYPE_SUBGSM:I = 0x5

.field private static final MMS_DB_SIM_SLOT1:I = 0xa

.field private static final MMS_DB_SIM_SLOT2:I = 0xb

.field private static final MMS_DB_SIM_SLOT_NONE:I = 0x0
...
.field private static PART_PROJECTION:[Ljava/lang/String; = null
...
.field private static final PDU_COLUMN_SIM_SLOT:I = 0x1c
...
.field private static PDU_PROJECTION:[Ljava/lang/String; = null
...
# instance fields
.field private isHEPProject:Ljava/lang/Boolean;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Lcom/google/android/mms/pdu/PduPersister;->mProperties:Landroid/os/Bundle;
    ...
    iput-object v3, p0, Lcom/google/android/mms/pdu/PduPersister;->mContentResolver:Landroid/content/ContentResolver;
    ...
    iput-object v3, p0, Lcom/google/android/mms/pdu/PduPersister;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    .line 280
    iget-object v3, p0, Lcom/google/android/mms/pdu/PduPersister;->isHEPProject:Ljava/lang/Boolean;
    ...
    iput-object v3, p0, Lcom/google/android/mms/pdu/PduPersister;->isHEPProject:Ljava/lang/Boolean;
    :try_end_0
    ...
    sput-object v3, Lcom/google/android/mms/pdu/PduPersister;->PDU_PROJECTION:[Ljava/lang/String;
    ...
    const-string v5, "ExtraUri"

    aput-object v5, v3, v4

    const/16 v4, 0xa

    const-string v5, "vCALs"

    aput-object v5, v3, v4

    const/16 v4, 0xb

    const-string v5, "vCALe"

    aput-object v5, v3, v4

    sput-object v3, Lcom/google/android/mms/pdu/PduPersister;->PART_PROJECTION:[Ljava/lang/String;
...
.method private getPhoneSlotByPhoneType(I)I
    .locals 12
    .param p1, "mmsDbPhoneType"    # I
    ...
    .line 1980
    .local v0, "slot1_phoneType":I
    const/4 v1, 0x0

    .line 1983
    .local v1, "slot2_phoneType":I
    ...
    invoke-virtual {v3, v8, v9}, Landroid/telephony/TelephonyManager;->getCurrentPhoneType(J)I
...
.method private isBlockedByTencent(Lcom/google/android/mms/pdu/GenericPdu;)Z
    .locals 22
    ...
    iget-object v4, v0, Lcom/google/android/mms/pdu/PduPersister;->isHEPProject:Ljava/lang/Boolean;
    ...
    .line 1898
    .local v10, "header":Lcom/google/android/mms/pdu/PduHeaders;
    ...
    const-string v5, "only block MT MMS."
    ...
    .line 1913
    :cond_2
    new-instance v3, Lcom/android/internal/telephony/TencentSecurityManager;

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/google/android/mms/pdu/PduPersister;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4}, Lcom/android/internal/telephony/TencentSecurityManager;-><init>(Landroid/content/Context;)V

    .line 1914
    .local v3, "manager":Lcom/android/internal/telephony/TencentSecurityManager;
    invoke-virtual {v3}, Lcom/android/internal/telephony/TencentSecurityManager;->bindTencentSecurityManager()Z

    move-result v12

    .line 1916
    .local v12, "isAvilable":Z
    if-nez v12, :cond_3

    .line 1917
    const-string v4, "PduPersister"

    const-string v5, "fail to bind Tencent service."
    ...
    invoke-virtual {v4}, Lcom/google/android/mms/pdu/MultimediaMessagePdu;->getBody()Lcom/google/android/mms/pdu/PduBody;
    ...
    invoke-virtual {v10, v4}, Lcom/google/android/mms/pdu/PduHeaders;->getEncodedStringValue(I)Lcom/google/android/mms/pdu/EncodedStringValue;
    ...
    .line 1926
    .local v7, "fromNumber":Ljava/lang/String;
    if-eqz v21, :cond_4
    ...
    .line 1934
    invoke-virtual {v2, v11}, Lcom/google/android/mms/pdu/PduBody;->getPart(I)Lcom/google/android/mms/pdu/PduPart;

    move-result-object v15

    .line 1935
    .local v15, "mmsPart":Lcom/google/android/mms/pdu/PduPart;
    ...
    .line 1936
    .local v18, "partType":Ljava/lang/String;
    ...
    .end local v8    # "textContent":Ljava/lang/String;
    ...
    .line 1944
    .end local v15    # "mmsPart":Lcom/google/android/mms/pdu/PduPart;
    .end local v18    # "partType":Ljava/lang/String;
    .restart local v8    # "textContent":Ljava/lang/String;
    :cond_6
    const/16 v14, 0xa

    .line 1945
    .local v14, "mmsDbSimSlot":I
    invoke-virtual/range {p1 .. p1}, Lcom/google/android/mms/pdu/GenericPdu;->getSimSlot()I
    ...
    invoke-virtual {v0, v4, v5}, Landroid/telephony/TelephonyManager;->getNetworkOperatorName(J)Ljava/lang/String;
    ...
    invoke-virtual/range {v3 .. v9}, Lcom/android/internal/telephony/TencentSecurityManager;->isBlockedMsg(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    :cond_8
    invoke-virtual {v3}, Lcom/android/internal/telephony/TencentSecurityManager;->unbindTencentSecurityManager()V
...
.method private loadParts(J)[Lcom/google/android/mms/pdu/PduPart;
    ...
    invoke-direct {v0, v15, v4}, Lcom/google/android/mms/pdu/PduPersister;->getIntegerFromPartColumn(Landroid/database/Cursor;I)Ljava/lang/Integer;
    ...
    invoke-virtual {v0, v4}, Lcom/google/android/mms/pdu/PduPart;->setCharset(I)V
    ...
    invoke-direct {v0, v15, v4}, Lcom/google/android/mms/pdu/PduPersister;->getByteArrayFromPartColumn(Landroid/database/Cursor;I)[B
    ...
    .line 502
    :try_start_2
    const-string v11, "text/x-vcal"

    .line 503
    .local v11, "TEXT_VCALENDAR_TOPAZ":Ljava/lang/String;
    ...
    .line 505
    .local v21, "ct":Ljava/lang/String;
    const-string v4, "text/x-vcal"
    ...
    const-string v5, "Replace content type."
    ...
    .line 515
    .end local v11    # "TEXT_VCALENDAR_TOPAZ":Ljava/lang/String;
    .end local v21    # "ct":Ljava/lang/String;
    :cond_7
    :goto_2
    const/4 v4, 0x6
    ...
    .line 523
    .restart local v21    # "ct":Ljava/lang/String;
    const-string v4, "text/x-vCalendar"
    ...
    invoke-interface {v15, v4}, Landroid/database/Cursor;->isNull(I)Z
    ...
    .line 552
    .local v30, "mVals":J
    new-instance v41, Ljava/lang/Long;
    ...
    .line 553
    .local v41, "temp":Ljava/lang/Long;
    if-eqz v41, :cond_c
    ...
    .end local v41    # "temp":Ljava/lang/Long;
    move-object/from16 v0, v41
    ...
    .line 559
    .restart local v41    # "temp":Ljava/lang/Long;
    if-eqz v41, :cond_d
    ...
    .line 573
    .local v43, "type":Ljava/lang/String;
    invoke-static/range {v43 .. v43}, Lcom/google/android/mms/ContentType;->isImageType(Ljava/lang/String;)Z

    move-result v4

    if-nez v4, :cond_10

    invoke-static/range {v43 .. v43}, Lcom/google/android/mms/ContentType;->isAudioType(Ljava/lang/String;)Z

    move-result v4

    if-nez v4, :cond_10

    invoke-static/range {v43 .. v43}, Lcom/google/android/mms/ContentType;->isVideoType(Ljava/lang/String;)Z
    ...
    invoke-static {v6}, Lcom/google/android/mms/pdu/CharacterSets;->getMimeName(I)Ljava/lang/String;
    ...
    invoke-virtual {v12, v13, v4, v5}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    :try_end_4
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_4 .. :try_end_4} :catch_1
    .catchall {:try_start_4 .. :try_end_4} :catchall_0

    .line 628
    .end local v13    # "blob":[B
    ...
    .end local v36    # "partId":J
    .end local v39    # "partURI":Landroid/net/Uri;
    .end local v43    # "type":Ljava/lang/String;
    :cond_11
    ...
    invoke-virtual {v12, v14, v4, v0}, Ljava/io/ByteArrayOutputStream;->write([BII)V
...
.method private persistData(Lcom/google/android/mms/pdu/PduPart;Landroid/net/Uri;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    invoke-static {v2, v3, v0}, Lcom/google/android/mms/util/DrmConvertSession;->open(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/mms/util/DrmConvertSession;
...
# virtual methods
.method public clearProperties()V
    .locals 1
    ...
    iput-object v0, p0, Lcom/google/android/mms/pdu/PduPersister;->mProperties:Landroid/os/Bundle;
...
.method public load(Landroid/net/Uri;)Lcom/google/android/mms/pdu/GenericPdu;
    ...
    iget-object v6, v0, Lcom/google/android/mms/pdu/PduPersister;->isHEPProject:Ljava/lang/Boolean;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/mms/pdu/GenericPdu;->setSimSlot(I)V
    ...
    invoke-direct {v0, v1}, Lcom/google/android/mms/pdu/PduPersister;->getPhoneSlotByPhoneType(I)I
...
.method public persist(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;ZZLjava/util/HashMap;)Landroid/net/Uri;
    ...
    .line 1495
    .local v45, "myPhoneNumber":Ljava/lang/String;
    ...
    invoke-direct/range {p0 .. p1}, Lcom/google/android/mms/pdu/PduPersister;->isBlockedByTencent(Lcom/google/android/mms/pdu/GenericPdu;)Z
    ...
    const-string v7, "MMS blocked by Tencent Security Manager."
    ...
    iget-object v6, v0, Lcom/google/android/mms/pdu/PduPersister;->mProperties:Landroid/os/Bundle;
    ...
    const-string v7, "SELF_PHONE_NUMBER"
    ...
    .line 1609
    .local v40, "localNumber":Ljava/lang/String;
    ...
    .local v19, "arr$":[Lcom/google/android/mms/pdu/EncodedStringValue;
    ...
    invoke-static {v6, v0}, Landroid/telephony/PhoneNumberUtils;->htc_compare(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v7, "Me phone number found in recipient list"
    ...
    .line 1610
    .end local v19    # "arr$":[Lcom/google/android/mms/pdu/EncodedStringValue;
    .end local v34    # "i$":I
    .end local v39    # "len$":I
    .end local v54    # "v":Lcom/google/android/mms/pdu/EncodedStringValue;
    :cond_1a
    ...
    .line 1648
    .end local v40    # "localNumber":Ljava/lang/String;
    :pswitch_2
    sget-object v18, Lcom/google/android/mms/pdu/PduPersister;->ADDRESS_FIELDS:[I
    ...
    invoke-direct {v0, v1, v2, v3, v6}, Lcom/google/android/mms/pdu/PduPersister;->loadRecipients(ILjava/util/HashSet;Ljava/util/HashMap;Z)V
    ...
    .restart local v41    # "messageSize":I
    ...
    .end local v48    # "recipients":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    .end local v49    # "set":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/String;>;>;"
    .end local v51    # "textOnly":Z
    .restart local p1    # "pdu":Lcom/google/android/mms/pdu/GenericPdu;
    :catch_1
    ...
    .restart local v48    # "recipients":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    .restart local v49    # "set":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/String;>;>;"
    .restart local v51    # "textOnly":Z
    :cond_24
    return-object v8
...
.method public persistPart(Lcom/google/android/mms/pdu/PduPart;JLjava/util/HashMap;)Landroid/net/Uri;
    ...
    .line 940
    :cond_7
    iget-object v11, p0, Lcom/google/android/mms/pdu/PduPersister;->isHEPProject:Ljava/lang/Boolean;
    ...
    .line 945
    .local v7, "temp":Ljava/lang/Long;
    if-eqz v7, :cond_9

    .line 946
    const-string v11, "vCALs"
    ...
    .end local v7    # "temp":Ljava/lang/Long;
    ...
    .line 949
    .restart local v7    # "temp":Ljava/lang/Long;
    if-eqz v7, :cond_a

    .line 950
    const-string v11, "vCALe"
    ...
    .end local v7    # "temp":Ljava/lang/Long;
    :cond_a
    iget-object v11, p0, Lcom/google/android/mms/pdu/PduPersister;->mContext:Landroid/content/Context;

    iget-object v12, p0, Lcom/google/android/mms/pdu/PduPersister;->mContentResolver:Landroid/content/ContentResolver;

    invoke-static {v11, v12, v8, v10}, Lcom/google/android/mms/util/SqliteWrapper;->insert(Landroid/content/Context;Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    const-string v12, "Failed to persist part, return null."
    ...
    const-string v12, "MIME type of the part must be set."
    ...
    invoke-direct {p0, p1, v6, v3, v0}, Lcom/google/android/mms/pdu/PduPersister;->persistData(Lcom/google/android/mms/pdu/PduPart;Landroid/net/Uri;Ljava/lang/String;Ljava/util/HashMap;)V
...
.method public setProperties(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 2027
    iput-object p1, p0, Lcom/google/android/mms/pdu/PduPersister;->mProperties:Landroid/os/Bundle;
...
.method public updateHeaders(Landroid/net/Uri;Lcom/google/android/mms/pdu/SendReq;Z)V
    ...
    .line 1301
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/SendReq;->getSimSlot()I
