...
.method static synthetic access$1000(Lcom/android/server/wifi/SupplicantStateTracker;)Lcom/android/internal/util/State;
    .locals 1
...
.method static synthetic access$1100(Lcom/android/server/wifi/SupplicantStateTracker;Lcom/android/internal/util/IState;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
...
.method static synthetic access$1200(Lcom/android/server/wifi/SupplicantStateTracker;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
...
.method static synthetic access$1202(Lcom/android/server/wifi/SupplicantStateTracker;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
    .param p1, "x1"    # Z
...
.method static synthetic access$1300(Lcom/android/server/wifi/SupplicantStateTracker;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
...
.method static synthetic access$1308(Lcom/android/server/wifi/SupplicantStateTracker;)I
    .locals 2
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
...
.method static synthetic access$500(Lcom/android/server/wifi/SupplicantStateTracker;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
...
.method static synthetic access$502(Lcom/android/server/wifi/SupplicantStateTracker;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
    .param p1, "x1"    # I
...
.method static synthetic access$508(Lcom/android/server/wifi/SupplicantStateTracker;)I
    .locals 2
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
    ...
    iput v1, p0, Lcom/android/server/wifi/SupplicantStateTracker;->mNetworkProblemCount:I
...
.method static synthetic access$700(Lcom/android/server/wifi/SupplicantStateTracker;Landroid/net/wifi/SupplicantState;ZZI)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
...
.method static synthetic access$800(Lcom/android/server/wifi/SupplicantStateTracker;)Lcom/android/server/wifi/WifiStateMachine;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
...
.method static synthetic access$900(Lcom/android/server/wifi/SupplicantStateTracker;Lcom/android/server/wifi/StateChangeResult;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/SupplicantStateTracker;
...
.method private sendSupplicantStateChangedBroadcast(Landroid/net/wifi/SupplicantState;ZZI)V
    ...
    const-string v4, "Failed to authenticate, count= "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/wifi/SupplicantStateTracker;->mAuthenticationFailuresCount:I
    ...
    const-string v4, "Failed to authenticate notification, count= "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/wifi/SupplicantStateTracker;->mAuthenticationFailuresNotificationCount:I
    ...
    .line 285
    iput v5, p0, Lcom/android/server/wifi/SupplicantStateTracker;->mAuthenticationFailuresCount:I
    ...
    invoke-direct {p0, p4, v2}, Lcom/android/server/wifi/SupplicantStateTracker;->handleNetworkConnectionFailure(II)V
    ...
    const-string v4, "Failed to connect due to network problem, count= "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/wifi/SupplicantStateTracker;->mNetworkProblemCount:I
    ...
    .line 301
    iget v2, p0, Lcom/android/server/wifi/SupplicantStateTracker;->mNetworkProblemCount:I
    ...
    .line 302
    iput v5, p0, Lcom/android/server/wifi/SupplicantStateTracker;->mNetworkProblemCount:I
    ...
    .line 309
    sput-boolean v5, Lcom/android/server/wifi/SupplicantStateTracker;->bAuthenticationFailuresFlag:Z
    ...
    invoke-virtual {v2}, Lcom/android/server/wifi/WifiStateMachine;->clearAuthErrorNotification()V
