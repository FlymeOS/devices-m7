...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, v1, Lcom/android/server/backup/BackupManagerService;->initflag:Z
...
.method static synthetic access$1400(Lcom/android/server/backup/BackupManagerService;)Landroid/app/IActivityManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
...
.method static synthetic access$1500(Lcom/android/server/backup/BackupManagerService;Landroid/os/ParcelFileDescriptor;Ljava/io/OutputStream;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
...
.method static synthetic access$1900(Lcom/android/server/backup/BackupManagerService;I)[B
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$2000(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;Ljava/lang/String;[BI)Ljavax/crypto/SecretKey;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$2100(Lcom/android/server/backup/BackupManagerService;)Ljava/security/SecureRandom;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
...
.method static synthetic access$2200(Lcom/android/server/backup/BackupManagerService;[B)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
    .param p1, "x1"    # [B
...
.method static synthetic access$2300(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;[B[BI)[B
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # [B
...
.method static synthetic access$2400(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$2600(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;)[B
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$2900(Lcom/android/server/backup/BackupManagerService;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
...
.method static synthetic access$2902(Lcom/android/server/backup/BackupManagerService;Ljava/util/List;)Ljava/util/List;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
...
.method static synthetic access$3000(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;Ljava/util/HashSet;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$900(Lcom/android/server/backup/BackupManagerService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/backup/BackupManagerService;
...
.method public BackupRestoreForExternalTransport(Ljava/lang/String;ZJ[Ljava/lang/String;)Z
    ...
    const-string v20, "BackupRestoreForExternalTransport"

    invoke-virtual/range {v18 .. v20}, Landroid/content/Context;->enforceCallingPermission(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 10341
    .local v16, "strTransportName":Ljava/lang/String;
    if-eqz v16, :cond_17
    ...
    const-string v19, "Running a external backup pass"
    ...
    .line 10354
    .local v17, "transmissionarray":[[Ljava/lang/String;
    const/16 v18, 0x1
    ...
    .line 10355
    .local v12, "namearray":[Ljava/lang/String;
    const/16 v18, 0x0
    ...
    invoke-virtual {v0, v11}, Lcom/android/server/backup/BackupManagerService$BackupHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    .end local v12    # "namearray":[Ljava/lang/String;
    .end local v17    # "transmissionarray":[[Ljava/lang/String;
    :goto_0
    return v18
    ...
    const-string v19, "Backup time but one already running"
    ...
    .line 10369
    :cond_3
    new-instance v13, Lcom/android/server/backup/BackupManagerService$RestoreObserver;

    move-object/from16 v0, p0

    invoke-direct {v13, v0}, Lcom/android/server/backup/BackupManagerService$RestoreObserver;-><init>(Lcom/android/server/backup/BackupManagerService;)V

    .line 10372
    .local v13, "observer":Lcom/android/server/backup/BackupManagerService$RestoreObserver;
    const/4 v5, 0x0
    ...
    .line 10375
    .local v10, "mRestore":Landroid/app/backup/IRestoreSession;
    if-nez v10, :cond_5
    ...
    const-string v19, "mRestore is null."
    ...
    .line 10384
    .local v15, "sets":[Landroid/app/backup/RestoreSet;
    invoke-interface {v10, v13}, Landroid/app/backup/IRestoreSession;->getAvailableRestoreSets(Landroid/app/backup/IRestoreObserver;)I
    ...
    .line 10386
    invoke-virtual {v13}, Lcom/android/server/backup/BackupManagerService$RestoreObserver;->waitForCompletion()V

    .line 10387
    iget-object v15, v13, Lcom/android/server/backup/BackupManagerService$RestoreObserver;->sets:[Landroid/app/backup/RestoreSet;
    ...
    .line 10390
    .local v14, "s":Landroid/app/backup/RestoreSet;
    iget-wide v0, v14, Landroid/app/backup/RestoreSet;->token:J
    ...
    const-string v20, "Scheduling restoreAll: "

    invoke-virtual/range {v19 .. v20}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v19

    iget-object v0, v14, Landroid/app/backup/RestoreSet;->name:Ljava/lang/String;
    ...
    invoke-interface {v10, v0, v1, v13}, Landroid/app/backup/IRestoreSession;->restoreAll(JLandroid/app/backup/IRestoreObserver;)I
    ...
    .end local v8    # "i$":I
    .end local v9    # "len$":I
    .end local v14    # "s":Landroid/app/backup/RestoreSet;
    :cond_7
    :goto_2
    if-nez v5, :cond_13
    ...
    const-string v19, "No available restore sets; no restore performed"
    ...
    .restart local v14    # "s":Landroid/app/backup/RestoreSet;
    :cond_a
    const/4 v5, 0x0
    ...
    const-string v20, "Scheduling restoreSome: "
    ...
    invoke-interface {v10, v0, v1, v13, v2}, Landroid/app/backup/IRestoreSession;->restoreSome(JLandroid/app/backup/IRestoreObserver;[Ljava/lang/String;)I
    ...
    const-string v19, "No matching restore set token.  Available sets:"
    ...
    const-string v19, "No restore sets"
    ...
    const-string v20, "retore end with external transport:"
    ...
    .line 10444
    .end local v7    # "err":I
    .end local v10    # "mRestore":Landroid/app/backup/IRestoreSession;
    .end local v15    # "sets":[Landroid/app/backup/RestoreSet;
    :catch_0
    move-exception v6
    ...
    const-string v19, "catch RemoteException when do external restore"

    move-object/from16 v0, v18

    move-object/from16 v1, v19

    invoke-static {v0, v1, v6}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    .end local v13    # "observer":Lcom/android/server/backup/BackupManagerService$RestoreObserver;
    :cond_17
    sget-boolean v18, Lcom/android/server/backup/BackupManagerService;->MORE_DEBUG:Z
    ...
    const-string v20, "this external transport name:"
    ...
    const-string v20, " doesn\'t exist."
...
.method public registerExternalTransport(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 10241
    .local v4, "transportComponent":Landroid/content/ComponentName;
    new-instance v3, Lcom/android/server/backup/BackupManagerService$ExternalTransport;

    invoke-direct {v3, p0, v4}, Lcom/android/server/backup/BackupManagerService$ExternalTransport;-><init>(Lcom/android/server/backup/BackupManagerService;Landroid/content/ComponentName;)V

    .line 10243
    .local v3, "newtransport":Lcom/android/server/backup/BackupManagerService$ExternalTransport;
    const-string v5, "BackupManagerService"
    ...
    const-string v7, "transportComponent.flattenToShortString()="
    ...
    invoke-direct {p0, v5}, Lcom/android/server/backup/BackupManagerService;->getTransportFromComponentName(Ljava/lang/String;)Lcom/android/internal/backup/IBackupTransport;
    ...
    const-string v7, "request connection, mContext = "
    ...
    invoke-virtual {v5, v1, v3, v6}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    const-string v6, "bind suceess but not connect yet"
    ...
    const-string v6, "add in mTransport successfull"
    ...
    const-string v6, "wait over 3s for IPC"
    ...
    const-string v6, "new transport not present"
    ...
    const-string v7, "register external transport:"
    ...
    const-string v7, "transport service:"
...
.method public setBackupEnabled(Z)V
    ...
    .local v2, "oldId":J
    :try_start_0
    iget-boolean v1, p0, Lcom/android/server/backup/BackupManagerService;->mEnabled:Z
    ...
    .line 9243
    :try_start_2
    iget-boolean v4, p0, Lcom/android/server/backup/BackupManagerService;->initflag:Z
    ...
    const-string v4, "com.htc.backup.SET_BACKUP_ENABLE"
    ...
    const-string v5, "send SET_Backup_ENABLE intent out."
    ...
    :try_start_3
    iget-boolean v4, p0, Lcom/android/server/backup/BackupManagerService;->mProvisioned:Z
    ...
    invoke-virtual {v4, v6, v8, v9, v7}, Landroid/app/AlarmManager;->set(IJLandroid/app/PendingIntent;)V
