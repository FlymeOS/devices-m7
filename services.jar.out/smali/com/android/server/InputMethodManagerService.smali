...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iget-object v2, p0, Lcom/android/server/InputMethodManagerService;->systemDir:Ljava/io/File;
    ...
    .line 3687
    new-instance v0, Lcom/android/server/InputMethodManagerService$10;

    iget-object v2, p0, Lcom/android/server/InputMethodManagerService;->screenFile:Ljava/io/File;
    ...
    invoke-direct {v0, p0, v2, v3}, Lcom/android/server/InputMethodManagerService$10;-><init>(Lcom/android/server/InputMethodManagerService;Ljava/lang/String;I)V

    iput-object v0, p0, Lcom/android/server/InputMethodManagerService;->screenObserver:Landroid/os/FileObserver;

    .line 3721
    new-instance v0, Lcom/android/server/InputMethodManagerService$11;
    ...
    invoke-direct {v0, p0, v2, v3}, Lcom/android/server/InputMethodManagerService$11;-><init>(Lcom/android/server/InputMethodManagerService;Ljava/lang/String;I)V
    ...
    .line 3736
    iput-object v1, p0, Lcom/android/server/InputMethodManagerService;->mPackageName:Ljava/lang/String;

    .line 3737
    iput-boolean v12, p0, Lcom/android/server/InputMethodManagerService;->mOnChangeflag:Z

    .line 3740
    iput-boolean v11, p0, Lcom/android/server/InputMethodManagerService;->mNeedToCheckIME:Z

    .line 3741
    iput-boolean v12, p0, Lcom/android/server/InputMethodManagerService;->mNeedToReselectDefaultIME:Z
    ...
    const-string v2, "screenStateFile does exist, use new mechanism!!"
    ...
    iget-object v2, p0, Lcom/android/server/InputMethodManagerService;->mImmsBroadcastReceiver:Lcom/android/server/InputMethodManagerService$ImmsBroadcastReceiver;
    ...
    const-string v2, "screenStateFile does not exist, use old mechanism!!"
...
.method static synthetic access$1600(Lcom/android/server/InputMethodManagerService;)Ljava/io/File;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/InputMethodManagerService;
...
.method static synthetic access$1700(Lcom/android/server/InputMethodManagerService;)Landroid/os/FileObserver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/InputMethodManagerService;
...
.method static synthetic access$1800(Lcom/android/server/InputMethodManagerService;)Landroid/os/FileObserver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/InputMethodManagerService;
...
.method static synthetic access$1900(Lcom/android/server/InputMethodManagerService;)Lcom/android/server/InputMethodManagerService$ImmsBroadcastReceiver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/InputMethodManagerService;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    invoke-interface {v6, v1, v10}, Lcom/android/internal/view/IInputMethod;->createSession(Landroid/view/InputChannel;Lcom/android/internal/view/IInputSessionCallback;)V
    :try_end_5
    ...
    iget-object v10, v7, Lcom/android/internal/view/InputBindResult;->channel:Landroid/view/InputChannel;
    ...
    invoke-static {v10}, Landroid/view/inputmethod/InputMethodManager;->getLogTag(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v13, " input method client, pid="
    ...
    iget v10, v4, Lcom/android/server/InputMethodManagerService$ClientState;->pid:I
    ...
    invoke-interface {v10, v8}, Lcom/android/internal/view/IInputMethodClient;->setUserActionNotificationSequenceNumber(I)V
    :try_end_d
    ...
    :sswitch_10
    iget-object v13, p0, Lcom/android/server/InputMethodManagerService;->mHardKeyboardListener:Lcom/android/server/InputMethodManagerService$HardKeyboardListener;
    ...
    :goto_b
    invoke-virtual {v13, v10}, Lcom/android/server/InputMethodManagerService$HardKeyboardListener;->handleHardKeyboardStatusChange(Z)V
...
.method showCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    sget-boolean v1, Landroid/view/inputmethod/InputMethodManager;->IMFdebug:Z
...
.method public showSoftInput(Lcom/android/internal/view/IInputMethodClient;ILandroid/os/ResultReceiver;)Z
    ...
    const-string v8, "Got RemoteException, uid="
...
.method startInputUncheckedLocked(Lcom/android/server/InputMethodManagerService$ClientState;Lcom/android/internal/view/IInputContext;Landroid/view/inputmethod/EditorInfo;I)Lcom/android/internal/view/InputBindResult;
    ...
    const-string v5, "switching to client, pid="
...
.method public updateStatusIcon(Landroid/os/IBinder;Ljava/lang/String;I)V
    ...
    const-string v3, "com.htc.permission.ACCESS_HTCIME_DATA"

    invoke-static {}, Landroid/os/Binder;->getCallingUid()I

    move-result v4

    invoke-virtual {v2, v3, v13, v4}, Landroid/content/Context;->checkPermission(Ljava/lang/String;II)I
    ...
    const-string v3, "No permission to perform test!"
    ...
    invoke-direct {v2, v0, v14, v9}, Lcom/android/server/InputMethodManagerService$5;-><init>(Lcom/android/server/InputMethodManagerService;ILjava/lang/String;)V

    invoke-virtual {v2}, Lcom/android/server/InputMethodManagerService$5;->start()V
    ...
    const-string v4, "Ignoring updateStatusIcon due to an invalid token. uid:"
    ...
    iget-object v2, v0, Lcom/android/server/InputMethodManagerService;->mStatusBar:Lcom/android/server/statusbar/StatusBarManagerService;
    ...
    iget-object v2, v0, Lcom/android/server/InputMethodManagerService;->mIPackageManager:Landroid/content/pm/IPackageManager;
    ...
    invoke-interface {v2, v0, v3, v4}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/android/server/statusbar/StatusBarManagerService;->setIcon(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)V
    ...
    .restart local v8    # "contentDescription":Ljava/lang/CharSequence;
    :cond_5
    const/4 v7, 0x0
