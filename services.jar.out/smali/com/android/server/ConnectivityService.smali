...
.field private static final HTC_HISTORY_ENTRIES:I = 0x8c

.field private static final HTC_HISTORY_LOG:Z = true

.field private static final HTC_HISTORY__EVENT_LEGACY_BROADCAST:I = 0x3

.field private static final HTC_HISTORY__EVENT_NETWORKINFO_UPDATE:I = 0x2

.field private static final HTC_HISTORY__EVENT_RELEASE_NETWORK:I = 0x4

.field private static final HTC_HISTORY__EVENT_REQUEST_NETWORK:I = 0x1

.field private static final HTC_HISTORY__EVENT_TOTAL:I = 0x5
...
# instance fields
.field private HTC_RESERVED_NETID_MAX:I

.field private HTC_RESERVED_NETID_MIN:I

.field private WIFI_RESTRICT_ENABLED:Ljava/lang/String;

.field private forceSignatureMatch:Z

.field private isPrepareVPN:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->isTetherBlockCheck:Z
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->specialSignatureMatchReq:Z
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->isPrepareVPN:Z
    ...
    iput v2, v0, Lcom/android/server/ConnectivityService;->HTC_RESERVED_NETID_MIN:I
    ...
    iput v2, v0, Lcom/android/server/ConnectivityService;->HTC_RESERVED_NETID_MAX:I
    ...
    .line 747
    new-instance v23, Landroid/net/NetworkCapabilities;

    invoke-direct/range {v23 .. v23}, Landroid/net/NetworkCapabilities;-><init>()V

    .line 748
    .local v23, "netCap":Landroid/net/NetworkCapabilities;
    const/16 v2, 0xc
    ...
    .line 766
    .local v16, "mCustManager":Lcom/htc/customization/HtcCustomizationManager;
    ...
    .line 769
    .local v17, "mCustReader":Lcom/htc/customization/HtcCustomizationReader;
    ...
    .line 775
    const-string v2, "isTetherBlockCheck"
    ...
    const-string v3, "HTC_CUSTOMIZATION: isTetherBlockCheck= "
    ...
    iget-boolean v3, v0, Lcom/android/server/ConnectivityService;->isTetherBlockCheck:Z
    ...
    iget-boolean v3, v0, Lcom/android/server/ConnectivityService;->specialSignatureMatchReq:Z
    ...
    const-string v3, "HTC_CUSTOMIZATION: isPrepareVPN= "
    ...
    iget-boolean v3, v0, Lcom/android/server/ConnectivityService;->isPrepareVPN:Z
    ...
    .line 794
    .end local v16    # "mCustManager":Lcom/htc/customization/HtcCustomizationManager;
    .end local v17    # "mCustReader":Lcom/htc/customization/HtcCustomizationReader;
    :goto_0
    move-object/from16 v0, p0
    ...
    :goto_1
    :try_start_2
    const-string v2, "ro.net.net_type.USBNET"
    ...
    .line 820
    const-string v2, "ro.net.apn_type.INTERNET"
    ...
    const-string v4, "enableINTERNET"
    ...
    .line 859
    .local v25, "powerManager":Landroid/os/PowerManager;
    const/4 v2, 0x1
    ...
    .line 876
    .local v21, "naStrings":[Ljava/lang/String;
    if-nez v21, :cond_3
    ...
    .line 884
    .local v20, "naString":Ljava/lang/String;
    :try_start_5
    new-instance v19, Landroid/net/NetworkConfig;

    invoke-direct/range {v19 .. v20}, Landroid/net/NetworkConfig;-><init>(Ljava/lang/String;)V
    ...
    .end local v13    # "i$":I
    .end local v15    # "len$":I
    .end local v20    # "naString":Ljava/lang/String;
    .end local v21    # "naStrings":[Ljava/lang/String;
    .end local v25    # "powerManager":Landroid/os/PowerManager;
    .end local v27    # "wifiOnly":Z
    :catch_0
    move-exception v10
    ...
    const-string v3, "Error setting apn/net type defintion e="
    ...
    .restart local v19    # "n":Landroid/net/NetworkConfig;
    .restart local v20    # "naString":Ljava/lang/String;
    .restart local v21    # "naStrings":[Ljava/lang/String;
    .restart local v25    # "powerManager":Landroid/os/PowerManager;
    .restart local v27    # "wifiOnly":Z
    :cond_4
    if-eqz v27, :cond_5
    ...
    .line 947
    .local v18, "mintentFilter":Landroid/content/IntentFilter;
    ...
    .end local v18    # "mintentFilter":Landroid/content/IntentFilter;
    :cond_c
    const/4 v2, 0x0
    ...
    .restart local v18    # "mintentFilter":Landroid/content/IntentFilter;
    :catch_6
    move-exception v10
...
.method static synthetic access$1400(Lcom/android/server/ConnectivityService;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$1600(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkCapabilities;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Lcom/android/server/connectivity/NetworkAgentInfo;
...
.method static synthetic access$1700(Lcom/android/server/ConnectivityService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$2200(Lcom/android/server/ConnectivityService;)Landroid/os/INetworkManagementService;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$2300(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Lcom/android/server/connectivity/NetworkAgentInfo;
    .param p2, "x2"    # Ljava/lang/String;
...
.method static synthetic access$2500(Lcom/android/server/ConnectivityService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$3000(Lcom/android/server/ConnectivityService;ZIILjava/lang/String;Landroid/app/PendingIntent;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # I
...
.method static synthetic access$3100(Lcom/android/server/ConnectivityService;)Landroid/util/SparseArray;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$3200(Lcom/android/server/ConnectivityService;I)Landroid/net/LinkProperties;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # I
...
.method static synthetic access$3400(Lcom/android/server/ConnectivityService;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$3500(Lcom/android/server/ConnectivityService;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$3600(Lcom/android/server/ConnectivityService;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$400(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;ZI)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Lcom/android/server/connectivity/NetworkAgentInfo;
    .param p2, "x2"    # Z
...
.method static synthetic access$4100(Lcom/android/server/ConnectivityService;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$4300(Lcom/android/server/ConnectivityService;Landroid/net/ProxyInfo;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$4400(Lcom/android/server/ConnectivityService;Lcom/android/server/ConnectivityService$NetworkFactoryInfo;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$4500(Lcom/android/server/ConnectivityService;Landroid/os/Messenger;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$4700(Lcom/android/server/ConnectivityService;Landroid/os/Message;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Landroid/os/Message;
...
.method static synthetic access$4900(Lcom/android/server/ConnectivityService;)Lcom/android/server/connectivity/Tethering;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$5000(Lcom/android/server/ConnectivityService;)Landroid/content/ContentResolver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$5002(Lcom/android/server/ConnectivityService;Landroid/content/ContentResolver;)Landroid/content/ContentResolver;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$5502(Lcom/android/server/ConnectivityService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Z
...
.method private assignNextNetId(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    iget v4, p0, Lcom/android/server/ConnectivityService;->HTC_RESERVED_NETID_MIN:I

    if-ne v2, v4, :cond_0

    .line 1015
    iget v2, p0, Lcom/android/server/ConnectivityService;->HTC_RESERVED_NETID_MAX:I
...
.method private getFilteredNetworkInfo(Landroid/net/NetworkInfo;II)Landroid/net/NetworkInfo;
    ...
    .line 1107
    const-string v1, "returning Blocked NetworkInfo"
...
.method private getNetworkInfo(II)Landroid/net/NetworkInfo;
    ...
    invoke-virtual {p0, p1, v2}, Lcom/android/server/ConnectivityService;->networkTypeConvert(IZ)I
    ...
    .line 1210
    invoke-direct {p0, v1, p2}, Lcom/android/server/ConnectivityService;->getFilteredNetworkInfo(II)Landroid/net/NetworkInfo;
...
.method private handleAsyncChannelDisconnected(Landroid/os/Message;)V
    ...
    const-string v19, " got DISCONNECTED, was satisfying "
    ...
    .line 2524
    iget-boolean v0, v12, Lcom/android/server/connectivity/NetworkAgentInfo;->created:Z
    ...
    invoke-interface/range {v18 .. v19}, Landroid/os/INetworkManagementService;->removeNetwork(I)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/ConnectivityService;->delMultiCastFilterRule(Landroid/net/NetworkInfo;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v19, "enable_cmcc_userdecided_wifi_mobile_handoff"

    const/16 v20, 0x1

    invoke-static/range {v18 .. v20}, Landroid/provider/HtcISettingsSystem$Agent;->getBoolean(Landroid/content/ContentResolver;Ljava/lang/String;Z)Z

    move-result v17

    .line 2543
    .local v17, "userEnableNotify":Z
    const/16 v18, 0x1
    ...
    .line 2545
    .local v10, "isWiFiDefaultNetwork":Z
    :goto_1
    const/4 v11, 0x0

    .line 2547
    .local v11, "mobiledata":Z
    :try_start_1
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/telephony/TelephonyManager;->getDataEnabled()Z
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    iget-boolean v0, v0, Lcom/android/server/ConnectivityService;->mIsShutdownOrReboot:Z
    ...
    const-string v19, "handleAsyncChannelDisconnected userEnableNotify="
    ...
    const-string v19, ", isWiFiDefaultNetwork="
    ...
    invoke-virtual/range {v18 .. v21}, Landroid/net/NetworkInfo;->setDetailedState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v18 .. v19}, Lcom/android/server/connectivity/NetworkMonitor;->sendMessage(I)V
    ...
    iget-object v0, v0, Lcom/android/server/ConnectivityService;->mNetworkForNetId:Landroid/util/SparseArray;
    ...
    .line 2586
    .local v16, "toActivate":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/connectivity/NetworkAgentInfo;>;"
    const/4 v8, 0x0
    ...
    .line 2588
    .local v14, "request":Landroid/net/NetworkRequest;
    move-object/from16 v0, p0
    ...
    iget v0, v14, Landroid/net/NetworkRequest;->requestId:I
    ...
    const-string v19, "Checking for replacement network to handle request "
    ...
    invoke-direct {v0, v14, v1, v2}, Lcom/android/server/ConnectivityService;->sendUpdatedScoreToFactories(Landroid/net/NetworkRequest;IZ)V
    ...
    .line 2607
    .local v3, "alternative":Lcom/android/server/connectivity/NetworkAgentInfo;
    move-object/from16 v0, p0
    ...
    .line 2609
    .local v7, "existing":Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    iget-object v0, v14, Landroid/net/NetworkRequest;->networkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    invoke-virtual/range {v18 .. v19}, Landroid/net/NetworkCapabilities;->satisfiedByNetworkCapabilities(Landroid/net/NetworkCapabilities;)Z
    ...
    .line 2536
    .end local v3    # "alternative":Lcom/android/server/connectivity/NetworkAgentInfo;
    .end local v4    # "currentNetwork":Lcom/android/server/connectivity/NetworkAgentInfo;
    .end local v6    # "entry":Ljava/util/Map$Entry;
    .end local v7    # "existing":Lcom/android/server/connectivity/NetworkAgentInfo;
    .end local v8    # "i":I
    .end local v9    # "i$":Ljava/util/Iterator;
    .end local v10    # "isWiFiDefaultNetwork":Z
    .end local v11    # "mobiledata":Z
    .end local v14    # "request":Landroid/net/NetworkRequest;
    .end local v15    # "skipMobileNotify":Z
    .end local v16    # "toActivate":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/connectivity/NetworkAgentInfo;>;"
    .end local v17    # "userEnableNotify":Z
    :catch_0
    move-exception v5
    ...
    const-string v19, "Exception removing network: "
    ...
    .restart local v17    # "userEnableNotify":Z
    :cond_9
    const/4 v10, 0x0
    ...
    .line 2548
    .restart local v10    # "isWiFiDefaultNetwork":Z
    .restart local v11    # "mobiledata":Z
    :catch_1
    move-exception v5
    ...
    const-string v19, "Exception to get mobile network setting, e="
    ...
    .line 2581
    .restart local v15    # "skipMobileNotify":Z
    :catchall_0
    move-exception v18
    ...
    .restart local v14    # "request":Landroid/net/NetworkRequest;
    .restart local v16    # "toActivate":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/connectivity/NetworkAgentInfo;>;"
    :cond_b
    move-object/from16 v0, p0
    ...
    .line 2622
    .restart local v3    # "alternative":Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    const-string v19, " found replacement in "
    ...
    .line 2637
    .local v13, "networkToActivate":Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    .line 2638
    iget-object v0, v13, Lcom/android/server/connectivity/NetworkAgentInfo;->networkMonitor:Lcom/android/server/connectivity/NetworkMonitor;
    ...
    invoke-direct {v0, v13, v1}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Z)V

    goto :goto_7

    .line 2642
    .end local v13    # "networkToActivate":Lcom/android/server/connectivity/NetworkAgentInfo;
    :cond_11
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->remove(Lcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method private handleReleaseNetworkRequest(Landroid/net/NetworkRequest;I)V
    ...
    const-string v8, " called by uid/pid="
...
.method private notifyUserSelection()V
    ...
    .line 5456
    iput-boolean v1, p0, Lcom/android/server/ConnectivityService;->mIsNotifying:Z

    .line 5457
    iget-object v0, p0, Lcom/android/server/ConnectivityService;->mDefaultRequest:Landroid/net/NetworkRequest;

    invoke-direct {p0, v0, v1, v1}, Lcom/android/server/ConnectivityService;->sendUpdatedScoreToFactories(Landroid/net/NetworkRequest;IZ)V
...
.method private rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Z)V
    ...
    const-string v20, "ERROR: uncreated network being rematched."
    ...
    const-string v20, "ERROR: nascent network not validated."
    ...
    invoke-virtual/range {v20 .. v21}, Landroid/net/NetworkCapabilities;->satisfiedByNetworkCapabilities(Landroid/net/NetworkCapabilities;)Z
    ...
    const-string v21, " was already satisfying"
    ...
    const-string v21, "  checking if request is satisfied: "
    ...
    const-string v21, "   accepting network in place of "
    ...
    invoke-virtual/range {v20 .. v21}, Landroid/util/SparseArray;->remove(I)V
    ...
    .line 4633
    :cond_9
    const-string v20, "   accepting network in place of null"
    ...
    const-string v21, " anymore. Remove request."
    ...
    invoke-interface/range {v20 .. v20}, Landroid/os/INetworkManagementService;->clearDefaultNetId()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v21, "Exception clear default network :"
    ...
    invoke-virtual {v13}, Lcom/android/server/connectivity/NetworkAgentInfo;->isVPN()Z

    move-result v20

    if-nez v20, :cond_10

    iget-boolean v0, v13, Lcom/android/server/connectivity/NetworkAgentInfo;->validated:Z
    ...
    .restart local v14    # "nr":Landroid/net/NetworkRequest;
    .restart local v18    # "teardown":Z
    :catch_1
    move-exception v8
    ...
    const-string v21, " not found in mNetworkRequests."
    ...
    const-string v21, "  it came from request list  of "
    ...
    invoke-virtual {v0, v13, v1}, Lcom/android/server/ConnectivityService;->notifyNetworkCallbacks(Lcom/android/server/connectivity/NetworkAgentInfo;I)V
    ...
    .line 4739
    new-instance v20, Landroid/net/IpPrefix;

    const-string v21, "239.255.255.255"
    ...
    invoke-direct/range {v20 .. v22}, Landroid/net/IpPrefix;-><init>(Ljava/net/InetAddress;I)V
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/net/NetworkInfo;->getState()Landroid/net/NetworkInfo$State;
    ...
    .line 4798
    const-string v20, "Validated network turns out to be unwanted.  Tear it down."
...
.method private sendLegacyNetworkBroadcast(Lcom/android/server/connectivity/NetworkAgentInfo;ZI)V
    ...
    .line 4991
    .local v1, "info":Landroid/net/NetworkInfo;
    invoke-virtual {p0, p3, v6}, Lcom/android/server/ConnectivityService;->networkTypeConvert(IZ)I

    move-result v4

    invoke-virtual {v1, v4}, Landroid/net/NetworkInfo;->setType(I)V
...
.method private setClatEnabled(Z)V
    .locals 3
    .param p1, "enabled"    # Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/connectivity/Nat464Xlat;->setClatEnabled(Z)V

    .line 1617
    iget-object v1, p0, Lcom/android/server/ConnectivityService;->mClat:Lcom/android/server/connectivity/Nat464Xlat;

    invoke-virtual {v1, v0}, Lcom/android/server/connectivity/Nat464Xlat;->htcCheckClatToStartOrStop(Lcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    .line 4878
    const-string v5, "ignoring duplicate network state non-change"
    ...
    invoke-direct {p0, v7, v5}, Lcom/android/server/ConnectivityService;->addToHtcConnSrvHistory(ILjava/lang/String;)V
    ...
    .line 4923
    :cond_4
    invoke-direct {p0, p1, v1}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Z)V
...
.method convertFeatureToNetworkType(ILjava/lang/String;)I
    ...
    .line 3380
    :cond_9
    const-string v1, "enableCALLERNAMEID"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v26, "Permission Denial: can\'t dump ConnectivityService from from pid="
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/util/IndentingPrintWriter;->println(Ljava/lang/String;)V
    ...
    .line 2098
    :cond_1
    const-string v23, "NetworkFactories for:"

    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/util/IndentingPrintWriter;->println(Ljava/lang/String;)V

    .line 2099
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/util/IndentingPrintWriter;->increaseIndent()V
    ...
    check-cast v18, Lcom/android/server/ConnectivityService$NetworkFactoryInfo;

    .line 2101
    .local v18, "nfi":Lcom/android/server/ConnectivityService$NetworkFactoryInfo;
    move-object/from16 v0, v18
    ...
    .line 2103
    .end local v18    # "nfi":Lcom/android/server/ConnectivityService$NetworkFactoryInfo;
    :cond_2
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/util/IndentingPrintWriter;->decreaseIndent()V

    .line 2104
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/util/IndentingPrintWriter;->println()V
    ...
    .line 2107
    .local v9, "defaultNai":Lcom/android/server/connectivity/NetworkAgentInfo;
    const-string v23, "Active default network: "

    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/util/IndentingPrintWriter;->print(Ljava/lang/String;)V
    ...
    .line 2115
    const-string v23, "Current Networks:"
    ...
    .line 2118
    .local v17, "nai":Lcom/android/server/connectivity/NetworkAgentInfo;
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/connectivity/NetworkAgentInfo;->toString()Ljava/lang/String;
    ...
    .line 2111
    .end local v12    # "i":I
    .end local v17    # "nai":Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/util/IndentingPrintWriter;->println(I)V
    ...
    .restart local v17    # "nai":Lcom/android/server/connectivity/NetworkAgentInfo;
    :cond_4
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/util/IndentingPrintWriter;->decreaseIndent()V

    .line 2126
    const-string v23, "Lingered:"
    ...
    check-cast v19, Landroid/net/NetworkRequest;

    .local v19, "nr":Landroid/net/NetworkRequest;
    ...
    .line 2129
    .end local v19    # "nr":Landroid/net/NetworkRequest;
    :cond_5
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/util/IndentingPrintWriter;->decreaseIndent()V

    .line 2132
    const-string v23, "MultiCastFilterRule: "
    ...
    .line 2145
    const-string v23, "Network Requests:"
    ...
    check-cast v20, Lcom/android/server/ConnectivityService$NetworkRequestInfo;

    .line 2148
    .local v20, "nri":Lcom/android/server/ConnectivityService$NetworkRequestInfo;
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/ConnectivityService$NetworkRequestInfo;->toString()Ljava/lang/String;
    ...
    .line 2150
    .end local v20    # "nri":Lcom/android/server/ConnectivityService$NetworkRequestInfo;
    :cond_8
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/util/IndentingPrintWriter;->println()V
    ...
    const-string v26, "mActiveDefaultNetwork: "
    ...
    .line 2156
    .local v4, "activeNetworkInfo":Landroid/net/NetworkInfo;
    if-eqz v4, :cond_9
    ...
    .line 2161
    .end local v4    # "activeNetworkInfo":Landroid/net/NetworkInfo;
    :cond_9
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/util/IndentingPrintWriter;->println()V

    .line 2163
    const-string v23, "mLegacyTypeTracker:"
    ...
    const-string v26, "NetworkTransitionWakeLock is currently "
    ...
    const-string v26, "It was last requested for "
    ...
    .line 2180
    .local v7, "dataTimeStamp":Ljava/util/Date;
    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J
    ...
    invoke-virtual/range {v23 .. v23}, Ljava/util/LinkedList;->toArray()[Ljava/lang/Object;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    const-string v26, "ConnSrv Change History: "
    ...
    const-string v26, " entries (current 0x"
    ...
    .local v21, "oHist":Ljava/lang/Object;
    ...
    .end local v7    # "dataTimeStamp":Ljava/util/Date;
    ...
    .end local v21    # "oHist":Ljava/lang/Object;
    ...
    .line 2186
    .restart local v7    # "dataTimeStamp":Ljava/util/Date;
    .restart local v16    # "mHistArray":[Ljava/lang/Object;
    ...
    const-string v27, "Log Exception : "
    ...
    .line 2206
    :cond_b
    const-string v23, "ConnSrv Change History: 140 entries"
    ...
    .line 2213
    const-string v23, "Inet condition reports:"
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/util/IndentingPrintWriter;->println(Ljava/lang/Object;)V
...
.method public getLinkPropertiesForType(I)Landroid/net/LinkProperties;
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/server/ConnectivityService;->networkTypeConvert(IZ)I
    ...
    .line 1326
    invoke-direct {p0, v0}, Lcom/android/server/ConnectivityService;->getLinkPropertiesForTypeInternal(I)Landroid/net/LinkProperties;
...
.method public getNetworkForType(I)Landroid/net/Network;
    ...
    invoke-virtual {p0, p1, v4}, Lcom/android/server/ConnectivityService;->networkTypeConvert(IZ)I
    ...
    .line 1280
    .local v2, "uid":I
    invoke-direct {p0, v1, v2}, Lcom/android/server/ConnectivityService;->isNetworkBlocked(II)Z
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->getNetworkForType(I)Lcom/android/server/connectivity/NetworkAgentInfo;
...
.method public htcPermittedTetherAllow(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/connectivity/Tethering;->htcPermittedTetherAllow(Ljava/lang/String;)Z
...
.method public networkTypeConvert(IZ)I
    .locals 3
    .param p1, "networkType"    # I
    .param p2, "revert"    # Z
    ...
    const-string v2, "networkTypeConvert: from "
...
.method public prepareVpn(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 3422
    .local v4, "user":I
    iget-boolean v5, p0, Lcom/android/server/ConnectivityService;->isPrepareVPN:Z
...
.method public requestNetwork(Landroid/net/NetworkCapabilities;Landroid/os/Messenger;ILandroid/os/IBinder;I)Landroid/net/NetworkRequest;
    ...
    invoke-direct {p0, v5, v1}, Lcom/android/server/ConnectivityService;->addToHtcConnSrvHistory(ILjava/lang/String;)V
...
.method public requestRouteToHostAddress(I[B)Z
    ...
    .line 1453
    invoke-virtual {p0, p1, v7}, Lcom/android/server/ConnectivityService;->networkTypeConvert(IZ)I
    ...
    invoke-virtual {v11, v6}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->getNetworkForType(I)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    invoke-virtual {v11, v6}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->isTypeSupported(I)Z
    ...
    .line 1505
    :try_start_5
    invoke-direct {p0, v2, v0, v4, v10}, Lcom/android/server/ConnectivityService;->addLegacyRouteToHost(Landroid/net/LinkProperties;Ljava/net/InetAddress;II)Z
...
.method public setPolicyEnable(IZI)V
    ...
    const-string v2, "setPolicyEnable("
    ...
    invoke-virtual {v2}, Landroid/net/ConnectivityManager$PolicyBlockReason;->getName()Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/server/ConnectivityService;->getPackageNamebyPID(IZ)Ljava/lang/String;
