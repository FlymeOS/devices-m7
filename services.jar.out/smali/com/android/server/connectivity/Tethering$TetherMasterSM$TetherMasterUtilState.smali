...
.method protected chooseUpstreamType(Z)V
    ...
    .line 1970
    .restart local v12    # "netType":Ljava/lang/Integer;
    move-object/from16 v0, p0
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/connectivity/Tethering;->access$4600(Lcom/android/server/connectivity/Tethering;)Landroid/net/ConnectivityManager;
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->isIpv6Connected(Landroid/net/LinkProperties;)Z
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/connectivity/Tethering;->access$600(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/net/wifi/WifiManager;->getWifidisplayApEnabled()Z
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/connectivity/Tethering;->access$6000(Lcom/android/server/connectivity/Tethering;)I
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->mPreferredUpstreamMobileApn:I
    invoke-static/range {v18 .. v18}, Lcom/android/server/connectivity/Tethering;->access$6000(Lcom/android/server/connectivity/Tethering;)I
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/connectivity/Tethering;->access$6100(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;
    ...
    const-string v20, "Setting DNS forwarders: Network="
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->mNMService:Landroid/os/INetworkManagementService;
    invoke-static/range {v18 .. v18}, Lcom/android/server/connectivity/Tethering;->access$3600(Lcom/android/server/connectivity/Tethering;)Landroid/os/INetworkManagementService;

    move-result-object v18

    move-object/from16 v0, v18

    invoke-interface {v0, v13, v3}, Landroid/os/INetworkManagementService;->setDnsForwarders(Landroid/net/Network;[Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6200(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/internal/util/State;

    move-result-object v19

    # invokes: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static/range {v18 .. v19}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6300(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
    ...
    const-string v19, "Warnning- No DNS server(can\'t apply default)"
...
.method isIpv6Connected(Landroid/net/LinkProperties;)Z
    ...
    .line 1933
    .local v4, "mIpv6Address":Ljava/lang/String;
    if-nez p1, :cond_0
    ...
    const-string v8, "Ipv6Tether, mIpv6Address = "
...
.method protected notifyTetheredOfNewUpstreamIface(Ljava/lang/String;)V
    ...
    invoke-static {v2, p1}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6402(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Ljava/lang/String;)Ljava/lang/String;

    .line 2088
    iget-object v2, p0, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->this$1:Lcom/android/server/connectivity/Tethering$TetherMasterSM;

    # getter for: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->mNotifyList:Ljava/util/ArrayList;
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6500(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Ljava/util/ArrayList;
...
.method protected declared-synchronized updateDhcpRange()Z
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$6600(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;
