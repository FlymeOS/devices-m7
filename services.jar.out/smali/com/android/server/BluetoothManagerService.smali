...
.field private static final DISABLE_TIME_MS:I = 0x4e20

.field private static final ENABLE_WHITELIST:[Ljava/lang/String;
...
.field private static final MESSAGE_TIMEOUT_DISABLE:I = 0x190
...
.method static constructor <clinit>()V
    ...
    const-string v2, "com.htc.htcbtwidget"
    ...
    const-string v2, "com.htc.rosiewidgets.powerstrip"

    aput-object v2, v0, v1

    const/4 v1, 0x7

    const-string v2, "com.htc.rosiewidgets.datastrip"

    aput-object v2, v0, v1

    const/16 v1, 0x8

    const-string v2, "com.htc.android.estress"

    aput-object v2, v0, v1

    const/16 v1, 0x9

    const-string v2, "com.htc.wifidisplay"
    ...
    const-string v2, "com.android.gpstool"
    ...
    const-string v2, "com.android.CSDFunctionR"

    aput-object v2, v0, v1

    const/16 v1, 0xf

    const-string v2, "com.htc.CSDFunctionR"

    aput-object v2, v0, v1

    sput-object v0, Lcom/android/server/BluetoothManagerService;->ENABLE_WHITELIST:[Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 312
    const-string v3, "com.htc.admin.ALLOW_BT_CHANGE"
...
.method static synthetic access$1200(Lcom/android/server/BluetoothManagerService;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$1202(Lcom/android/server/BluetoothManagerService;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$1400(Lcom/android/server/BluetoothManagerService;)Lcom/android/server/BluetoothManagerService$BluetoothServiceConnection;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$1500(Lcom/android/server/BluetoothManagerService;)Landroid/bluetooth/IBluetooth;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$2100(Lcom/android/server/BluetoothManagerService;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$2102(Lcom/android/server/BluetoothManagerService;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$2200(Lcom/android/server/BluetoothManagerService;)V
    ...
    .prologue
    .line 60
    invoke-direct {p0}, Lcom/android/server/BluetoothManagerService;->killBluetoothServiceFromMis()V
...
.method static synthetic access$2602(Lcom/android/server/BluetoothManagerService;Landroid/bluetooth/IBluetoothGatt;)Landroid/bluetooth/IBluetoothGatt;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method private bluetoothStateChangeHandler(II)V
    ...
    invoke-virtual {p0, v0, v5, v6, v7}, Lcom/android/server/BluetoothManagerService;->doBind(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
...
.method private static debugGetMessageName(I)Ljava/lang/String;
    ...
    .line 135
    :sswitch_d
    const-string v0, "MESSAGE_TIMEOUT_DISABLE"
...
.method private isBluetoothRestrictedInternal()Z
    .locals 5
    ...
    const-string v4, "bluetooth_restriction"
    ...
    const-string v4, "isBluetoothRestricted(): "
...
.method private killBluetoothServiceFromMis()V
    .locals 5
    ...
    const-string v3, "killBluetoothServiceFromMis"
    ...
    const-string v3, "kill droid.bluetooth..."

    invoke-static {v2, v3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1611
    const-string v2, "droid.bluetooth"

    invoke-static {v2}, Landroid/os/Process;->getPid(Ljava/lang/String;)I
    ...
    const-string v4, "Fake Bluetooth State Change Intent: "
...
.method public checkBTEasState(I)Z
    ...
    const-string v5, "checkBTEasState, ret="
...
.method public enable()Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/BluetoothManagerService;->checkIfCallerIsForegroundUser()Z
    ...
    const-string v21, "enable(): not allowed for non-active and non system user"
    ...
    const-string v21, "android.permission.BLUETOOTH_ADMIN"

    const-string v22, "Need BLUETOOTH ADMIN permission"
    ...
    .line 537
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/BluetoothManagerService;->enableRestrictionCheck()Z
    ...
    .line 544
    .local v7, "customManager":Lcom/htc/customization/HtcCustomizationManager;
    ...
    .line 545
    .local v10, "customReader":Lcom/htc/customization/HtcCustomizationReader;
    const-string v20, "region"
    ...
    invoke-interface {v10, v0, v1}, Lcom/htc/customization/HtcCustomizationReader;->readInteger(Ljava/lang/String;I)I

    move-result v17

    .line 546
    .local v17, "regionId":I
    const-string v20, "BluetoothManagerService"
    ...
    const-string v22, "enable(): region ID = "
    ...
    .line 551
    .local v6, "callerPackageNames":[Ljava/lang/String;
    move-object v4, v6
    ...
    const-string v22, "enable(): Parsed package name is "
    ...
    .line 553
    sget-object v5, Lcom/android/server/BluetoothManagerService;->ENABLE_WHITELIST:[Ljava/lang/String;
    ...
    .line 554
    .local v18, "whiteList":Ljava/lang/String;
    ...
    const-string v21, "enable(): Matched white list"
    ...
    .line 561
    .end local v18    # "whiteList":Ljava/lang/String;
    :cond_2
    if-eqz v19, :cond_5
    ...
    const-string v20, "android.bluetooth.adapter.action.REQUEST_ENABLE"
    ...
    .restart local v18    # "whiteList":Ljava/lang/String;
    :cond_4
    ...
    .line 576
    .end local v5    # "arr$":[Ljava/lang/String;
    .end local v6    # "callerPackageNames":[Ljava/lang/String;
    .end local v12    # "i$":I
    .end local v15    # "len$":I
    .end local v16    # "names":Ljava/lang/String;
    .end local v19    # "whiteListMatch":Z
    :cond_6
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/BluetoothManagerService;->mHandler:Lcom/android/server/BluetoothManagerService$BluetoothHandler;
    ...
    const-string v22, "enable():  mBluetooth ="
    ...
    iget-object v0, v0, Lcom/android/server/BluetoothManagerService;->mBluetooth:Landroid/bluetooth/IBluetooth;
    ...
    iget-boolean v0, v0, Lcom/android/server/BluetoothManagerService;->mBinding:Z
    ...
    iget-object v0, v0, Lcom/android/server/BluetoothManagerService;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean v0, v1, Lcom/android/server/BluetoothManagerService;->mQuietEnableExternal:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/BluetoothManagerService;->mEnableExternal:Z
    ...
    invoke-direct {v0, v1}, Lcom/android/server/BluetoothManagerService;->persistBluetoothSetting(I)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/BluetoothManagerService;->sendEnableMsg(Z)V
...
.method public enableNoAutoConnect()Z
    ...
    .line 505
    invoke-virtual {p0}, Lcom/android/server/BluetoothManagerService;->enableRestrictionCheck()Z
...
.method public enableRadio(I)Z
    ...
    const-string v2, "enableRadio(): not allowed for non-active and non system user"
...
.method public enableRestrictionCheck()Z
    .locals 4
    ...
    const-string v3, "checking for enable restriction..."

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1753
    invoke-virtual {p0, v0}, Lcom/android/server/BluetoothManagerService;->checkBTEasState(I)Z
    ...
    .line 1758
    :cond_0
    invoke-direct {p0}, Lcom/android/server/BluetoothManagerService;->isBluetoothRestrictedInternal()Z
    ...
    const-string v2, "Bluetooth enable is restricted by restriction policy"
...
.method public isBluetoothTetheringRestricted()Z
    ...
    const-string v5, "android.permission.ACCESS_HTC_MDM_API"
    ...
    .line 1705
    .local v0, "content":Landroid/content/ContentResolver;
    const-string v4, "bluetooth_pan_restriction"
    ...
    const-string v4, "isBluetoothTetheringRestricted(): "
...
.method public setBluetoothRestricted(Z)V
    ...
    const-string v6, "com.sprint.internal.permission.DEVICEMANAGEMENT"

    const-string v7, "Need Sprint device management permission"
    ...
    const-string v7, "setBluetoothRestricted(): "
    ...
    .line 1675
    const-string v6, "bluetooth_restriction"
    ...
    const-string v4, "setBluetoothRestricted(true) and current state is not off, shutoff Bluetooth"
...
.method public setBluetoothTetheringRestricted(Z)V
    ...
    const-string v4, "android.permission.ACCESS_HTC_MDM_API"
    ...
    const-string v5, "setBluetoothTetheringRestricted(): "
